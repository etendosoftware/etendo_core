...
public class SequencesGenerator extends Action {
    ...
    protected ActionResult action(JSONObject parameters, MutableBoolean isStopped) {
        ...
        try {
            ...
            Reference reference = OBDal.getInstance().get(Reference.class, TransactionalSequenceUtils.TRANSACTIONAL_SEQUENCE_ID);
    ...
    public boolean hasDocType(Table t){
        ...
        return  entity.hasProperty(SequenceDatabaseUtils.PROPERTY_DOCUMENTTYPE) ||entity.hasProperty(SequenceDatabaseUtils.PROPERTY_DOCUMENTTYPE_TARGET);
    }

    public int createSequence(Client client, Organization organization, String name, Column column, DocumentType documentType) {
