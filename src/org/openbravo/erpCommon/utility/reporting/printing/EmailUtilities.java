...
public class EmailUtilities {
    ...
    private static Collection<? extends File> getDocumentAttachments(String documentId) throws IOException {
        ...
        try {
            ...
            attachmentMetadataCriteria.addEqual(ParameterValue.PROPERTY_VALUESTRING, ReportManager.GENERATED_BY_EMAILING);
            // TODO: Migrar Projections a CriteriaBuilder con multiselect/select manualmente
            attachmentMetadataCriteria.setProjection(// TODO: Migrar Projections a CriteriaBuilder (select, groupBy, etc.) manualmente
Projections.id());
