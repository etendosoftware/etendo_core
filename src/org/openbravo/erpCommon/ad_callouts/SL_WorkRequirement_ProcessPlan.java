...
public class SL_WorkRequirement_ProcessPlan extends SimpleCallout {
  ...
  protected void execute(CalloutInfo info) throws ServletException {
    ...
    // Parameters
    String strProcessPlan = info.getStringParameter("inpmaProcessplanId", IsIDFilter.instance);
    ...
    if (data != null && data.length > 0) {
      ...
      info.addResult("inpexplodephases", "N");
      info.addResult("inpconversionrate", BigDecimal.ONE);
      info.addResult("inpsecondaryunit", null);
    }
  }
}
