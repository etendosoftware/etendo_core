...
public class AttributeSetInstance extends HttpSecureAppServlet {
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars, String strInstance,
      ...
      String strLocator, String strIsSOTrx, String strProduct)
      throws IOException, ServletException {
    ...
    XmlDocument xmlDocument = xmlEngine
        .readXmlTemplate("org/openbravo/erpCommon/info/AttributeSetInstance")
        .createXmlDocument();
    ...
    xmlDocument.setParameter("data",
        generateHtml(vars, data,
            AttributeSetInstanceData.selectInstance(this,
                (localStrInstance.equals("") ? strProductInstance : localStrInstance)),
  ...
  private String generateHtml(VariablesSecureApp vars, AttributeSetInstanceData[] fields,
    ...
    if (fields[0].islot.equals("Y")) {
      ...
      if (!fields[0].mLotctlId.equals("")
          && (strIsSOTrx.equals("N") || strWindowId.equals("191"))) {
        strHtml.append(" readonly\" readonly=true ");
      } else {
        strHtml.append("\" ");
      }
      if (strAttributeInstance.equals("")
          && (strIsSOTrx.equals("N") || strWindowId.equals("191"))) {
        strHtml.append(
            "value=\"" + AttributeSetInstanceData.selectNextLot(this, fields[0].mLotctlId) + "\" ");
      } else {
        strHtml.append("value=\""
            + Utility.formatMessageBDToHtml(
    ...
    if (fields[0].isguaranteedate.equals("Y")) {
      ...
      if (strAttributeInstance.equals("")
        ...
        strGuaranteeDate = (instanceData != null && instanceData.length > 0)
            ? instanceData[0].guaranteedate
            : "";
      }
      ...
      strHtml.append(
          " type=\"text\" name=\"inpDateFromxxxinternalOB\" id=\"paramDateFromxxxinternalOB\" size=\"10\" maxlength=\"10\" value=\""
              + strGuaranteeDate
      ...
      strHtml.append(
          "onfocus=\"this.className='FieldButtonLink_hover'; window.status='Show calendar'; return true;\"");
      ...
      strHtml.append(
          ...
          .append("/images/blank.gif\" border=\"0\"\"/>");
      strHtml.append("</td>");
      strHtml.append("</tr>");
