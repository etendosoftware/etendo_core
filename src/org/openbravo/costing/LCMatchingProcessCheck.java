...
/**
 * Define needed checks for Landed Cost Matching process. Note that classes implementing this
 * interface should be annotated as {@code @ApplicationScoped}.
 */
public interface LCMatchingProcessCheck {
   ...
   */
  void doCheck(LandedCostCost lcCost, JSONObject message) throws OBException;
}
