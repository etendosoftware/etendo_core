...
public class Entity {
  ...
  private List<Property> sequencedColumnProperties;
  ...
  public static final String SEQUENCE_CONTRIBUTOR_CLASS_APPENDIX = "SequenceContributor";
  ...
  public void initialize(Table table) {
    ...
    sequencedColumnProperties = new ArrayList<>();
    ...
    for (final Column c : table.getColumns()) {
      ...
      if (p.isSequence()) {
        sequencedColumnProperties.add(p);
      }
    }
  ...
  /**
   *
   * @return true when there are columns defined with a Sequence reference
   */
  public boolean hasSequencedColumns() {
    return sequencedColumnProperties != null && !sequencedColumnProperties.isEmpty();
  }

  public List<Property> getSequencedColumnProperties() {
    return sequencedColumnProperties;
  }
