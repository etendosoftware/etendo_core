...
/** Exposes {@link ImportEntryManager} as a JMX Bean to be able to log for debugging. */
public interface ImportEntryManagerMBean {

  /**
   * Logs ImportEntryManager's current status with information about all the queued and processing
   * entries.
   */
