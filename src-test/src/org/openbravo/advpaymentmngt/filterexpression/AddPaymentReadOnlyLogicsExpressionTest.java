...
public class AddPaymentReadOnlyLogicsExpressionTest {
    ...
    private static final String ERROR_MSG = "No handler found for window";
    ...
    public void setUp() throws Exception {
        ...
        requestMap = createRequestMap(TEST_WINDOW_ID);

        mockedOBMessageUtils.when(() -> OBMessageUtils.messageBD("APRM_NOHANDLER"))
            .thenReturn(ERROR_MSG);

        when(addPaymentFilterExpressionHandlers.select(any())).thenReturn(
            new FilteredInstanceMock<>(mockHandler)
        );
    ...
    public void testGetExpressionPaymentDocumentNo() throws JSONException {
        setCurrentParam("payment_documentno_readonly_logic");
    ...
    public void testGetExpressionWithNoHandler() {
        ...
        OBException exception = assertThrows(OBException.class,
            () -> expressionUnderTest.getExpression(requestMap));
    ...
    public void testGetExpressionWithExceptionInHandler() throws JSONException {
        setCurrentParam("payment_documentno_readonly_logic");
        when(mockHandler.getPaymentDocumentNoReadOnlyLogic(requestMap))
