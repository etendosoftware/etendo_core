...
public class TransactionAddPaymentReadOnlyLogicsTest extends OBBaseTest {
  ...
  public void setUp() throws Exception {
    ...
    when(mockOBDal.get(FIN_FinancialAccount.class, "testFinancialAccountId")).thenReturn(mockFinancialAccount);
    when(mockOBDal.get(FIN_PaymentMethod.class, "testPaymentMethodId")).thenReturn(mockPaymentMethod);
  }
   ...
   */
  @Test
  public void testGetActualPaymentReadOnlyLogic_BPD() throws JSONException {
    // Given
   ...
   */
  @Test
  public void testGetActualPaymentReadOnlyLogic_RCIN() throws JSONException {
    // Given
    JSONObject context = new JSONObject();
   ...
   */
  @Test
  public void testGetActualPaymentReadOnlyLogic_OtherDocType() throws JSONException {
    // Given
    JSONObject context = new JSONObject();
   ...
   */
  @Test
  public void testGetActualPaymentReadOnlyLogic_TransactionWindow() throws JSONException {
    // Given
    JSONObject context = new JSONObject();
   ...
   */
  @Test
  public void testGetActualPaymentReadOnlyLogic_OtherWindow() throws JSONException {
    // Given
    JSONObject context = new JSONObject();
   ...
   */
  @Test
  public void testGetCurrencyReadOnlyLogic_RCIN_Multicurrency() throws JSONException {
    // Given
    JSONObject context = new JSONObject();
    context.put("trxtype", "RCIN");
    context.put("fin_financial_account_id", "testFinancialAccountId");
    context.put("fin_paymentmethod_id", "testPaymentMethodId");
    requestMap.put("context", context.toString());
   ...
   */
  @Test
  public void testGetCurrencyReadOnlyLogic_RCIN_NonMulticurrency() throws JSONException {
    // Given
    JSONObject context = new JSONObject();
    context.put("trxtype", "RCIN");
    context.put("fin_financial_account_id", "testFinancialAccountId");
   ...
   */
  @Test
  public void testGetCurrencyReadOnlyLogic_BPD_Multicurrency() throws JSONException {
    // Given
    JSONObject context = new JSONObject();
    context.put("trxtype", "BPD");
    context.put("fin_financial_account_id", "testFinancialAccountId");
   ...
   */
  @Test
  public void testGetCurrencyReadOnlyLogic_PDOUT_Multicurrency() throws JSONException {
    // Given
    JSONObject context = new JSONObject();
    context.put("trxtype", "PDOUT");
    context.put("fin_financial_account_id", "testFinancialAccountId");
    context.put("fin_paymentmethod_id", "testPaymentMethodId");
    requestMap.put("context", context.toString());
   ...
   */
  @Test
  public void testGetCurrencyReadOnlyLogic_BPW_Multicurrency() throws JSONException {
    // Given
    JSONObject context = new JSONObject();
