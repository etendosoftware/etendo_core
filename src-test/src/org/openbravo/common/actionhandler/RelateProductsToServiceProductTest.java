...
public class RelateProductsToServiceProductTest {
  ...
  public void testDoExecuteWithEmptySelection() throws Exception {
    ...
    assertEquals("No lines selected", result.getJSONObject("message").getString("title"));
  }
  ...
  public void testDoExecuteWithValidSelection() throws Exception {
    ...
    when(mockOBDal.getProxy(Product.ENTITY_NAME, "TEST_SERVICE_PRODUCT")).thenReturn(mockServiceProduct);
    when(mockOBDal.getProxy(Client.ENTITY_NAME, "TEST_CLIENT")).thenReturn(mockClient);
    when(mockOBDal.getProxy(Organization.ENTITY_NAME, "TEST_ORG")).thenReturn(mockOrg);
    ...
    assertEquals("Success", result.getJSONObject("message").getString("title"));
  }
  ...
  public void testDoExecuteWithException() throws Exception {
    ...
    when(mockOBDal.getProxy(eq(Product.ENTITY_NAME), eq("TEST_SERVICE_PRODUCT"))).thenThrow(testException);
    ...
    assertEquals("error", result.getJSONObject("message").getString("severity"));
    assertEquals("Translated test exception", result.getJSONObject("message").getString("text"));
  }
  ...
  private String createValidContent() throws JSONException {
    ...
    content.put("inpmProductId", "TEST_SERVICE_PRODUCT");
    content.put("inpadClientId", "TEST_CLIENT");
    content.put("inpadOrgId", "TEST_ORG");
