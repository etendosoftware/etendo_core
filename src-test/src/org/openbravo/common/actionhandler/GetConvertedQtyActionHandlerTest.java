...
public class GetConvertedQtyActionHandlerTest {
  ...
  public void testExecuteReverseConversion() throws Exception {
    String mProductId = "prod123";
    BigDecimal qty = new BigDecimal("100.0");
    String toUOM = "UOM456";
    Boolean reverse = true;

    JSONObject inputData = new JSONObject();
    inputData.put("mProductId", mProductId);
    inputData.put("qty", qty.toString());
    inputData.put("toUOM", toUOM);
    inputData.put("reverse", reverse);
