...
public class KillProcessTest {
  ...
  public void testGetTranslatedExceptionMessageExistingTranslation() throws Exception {
    ...
    when(mockThrowable.getMessage()).thenReturn("TestErrorCode");

    mockedOBMessageUtils.when(() -> OBMessageUtils.getI18NMessage("TestErrorCode", null)).thenReturn(
  ...
  public void testGetTranslatedExceptionMessageNoTranslation() throws Exception {
    ...
    mockedOBMessageUtils.when(() -> OBMessageUtils.getI18NMessage("TestErrorCode", null)).thenReturn(null);
    ...
    assertEquals("TestErrorCode", result);
  }
}
