...
public class ConfirmCancelAndReplaceSalesOrderTest {
  ...
  public void setUp() {
    ...
    mockedOBMessageUtils.when(() -> OBMessageUtils.messageBD("Success")).thenReturn(SUCCESS_MESSAGE);
    mockedOBMessageUtils.when(() -> OBMessageUtils.messageBD("Error")).thenReturn(ERROR_MESSAGE);
  }
  ...
  public void testDoExecuteSuccess() throws Exception {
    ...
    assertEquals(SUCCESS_MESSAGE, message.getString("title"));
  ...
  public void testDoExecuteCancelAndReplaceError() throws Exception {
    ...
    assertEquals(ERROR_MESSAGE, message.getString("title"));
