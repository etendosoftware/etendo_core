...
public class SimpleCalloutCalloutInfoTest {
  ...
  @Test
  public void testGetLastFieldChanged() {
    assertEquals("inpfield1", info.getLastFieldChanged());
  }

  @Test
  public void testGetTabId() {
  ...
  @Test
  public void testAddStringResult() throws Exception {
  ...
  @Test
  public void testAddObjectResult() throws Exception {
  ...
  @Test
  public void testAddNullResult() throws Exception {
  ...
  @Test
  public void testQuotedEmptyStringConvertedToEmpty() throws Exception {
  ...
  @Test
  public void testNullStringConvertedToJsonNull() throws Exception {
  ...
  @Test
  public void testOverwritesPreviousValue() throws Exception {
  ...
  @Test
  public void testAddsJsExecuteKey() throws Exception {
  ...
  @Test
  public void testAddSelectInitializesCombo() {
  ...
  @Test
  public void testAddSelectResultUnselected() throws Exception {
    info.addSelect(INP_COMBO);
  ...
  @Test
  public void testAddSelectResultSelected() throws Exception {
    info.addSelect(INP_COMBO);
  ...
  @Test
  public void testRemoveSelectResult() throws Exception {
    info.addSelect(INP_COMBO);
    info.addSelectResult("id1", OPTION_A);
    info.addSelectResult("id2", "Option B");
  ...
  @Test
  public void testEndSelectEmptyCombo() throws Exception {
    info.addSelect(INP_COMBO);
    info.endSelect();
  ...
  @Test
  public void testReturnsValueFromVars() {
  ...
  @Test
  public void testReturnsModifiedValueFromResult() throws Exception {
    info.addResult(INP_NAME, "modified");
    assertEquals("modified", info.getStringParameter(INP_NAME, null));
  }

  @Test
  public void testOverloadWithoutFilter() {
  ...
  @Test
  public void testGetResultReturnsJsonString() {
  ...
  @Test
  public void testGetJSONObjectResultReturnsObject() {
    assertNotNull(info.getJSONObjectResult());
  }

  @Test
  public void testEmptyResultIsEmptyJson() {
    assertEquals("{}", info.getResult());
  }

  @Test
  public void testResultReflectsAddedValues() throws Exception {
  ...
  @Test
  public void testReturnsParsedValue() throws ServletException {
    when(vars.getNumericParameter(INP_QTY, "0")).thenReturn("25.5");
  ...
  @Test
  public void testReturnsZeroWhenParamMissing() throws ServletException {
  ...
  @Test
  public void testLargeNumber() throws ServletException {
  ...
  @Test
  public void testNegativeNumber() throws ServletException {
  ...
  @Test
  public void testChainsCalloutExecution() throws ServletException {
  ...
  @Test
  public void testChainedCalloutSharesResult() throws ServletException {
  ...
  @Test
  public void testChainedCalloutCanOverwriteValues() throws ServletException {
  ...
  @Test
  public void testMultipleChainedCallouts() throws ServletException {
  ...
  @Test
  public void testChainedCalloutExceptionDoesNotCorruptResult() throws ServletException {
