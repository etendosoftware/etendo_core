...
public class CLFOTestDataPO_15 extends CopyLinesFromOrdersTestData {
  ...
  private static String TEST_ORDERFROM1_DOCUMENTNO = "CLFOTestData15_OrderFrom1";
  private static String TEST_ORDERTO1_DOCUMENTNO = "CLFOTestData15_OrderTo1";
  ...
  public void initialize() {
    ...
    orderToBeProcessed.setBusinessPartnerId(BPartnerDataConstants.VENDOR_B);
    orderToBeProcessed.setBusinessPartnerLocationId(BPartnerDataConstants.VENDOR_B_LOCATION_ID);
    ...
    expectedOrderLines.put("10",
        new String[] { CLFOTestConstants.RAW_MATERIAL_A_PRODUCT_NAME, "10",
            ...
            TEST_ORDERFROM1_DOCUMENTNO, BPartnerDataConstants.VENDOR_B_LOCATION,
