...
/**
 * Check the created line has the header's business partner as BP. And if header has partner address
 * defined then it is used as BP address or the last address created for the header's BP.
 * 
 * @author Mark
 * 
 */
public class CLFOTestDataSO_03 extends CopyLinesFromOrdersTestData {

  private static String TEST_ORDERFROM1_DOCUMENTNO = "CLFOTestData3_OrderFrom1";
  private static String TEST_ORDERTO1_DOCUMENTNO = "CLFOTestData3_OrderTo1";
  ...
  public void initialize() {
    ...
    orderToBeProcessed.setBusinessPartnerId(BPartnerDataConstants.CUSTOMER_B);
    orderToBeProcessed.setBusinessPartnerLocationId(BPartnerDataConstants.CUSTOMER_B_LOCATION_ID);
    orderToBeProcessed.setPriceListId(CLFOTestConstants.CUSTOMER_B_PRICE_LIST_ID);
    ...
    orderToBeProcessed.setDescription("Processing Order Description");
     ...
     */
    setExpectedOrderAmounts(new String[] { "20.00", "20.60" });
    ...
    expectedOrderLines.put("10",
        new String[] { CLFOTestConstants.FINAL_GOOD_C_PRODUCT_NAME, "10",
            CLFOTestConstants.BAG_UOM_NAME, "2.00", "2.00", "0", CLFOTestConstants.VAT3_TAX_NAME,
            TEST_ORDERFROM1_DOCUMENTNO, BPartnerDataConstants.CUSTOMER_B_LOCATION,
