...
public class CLFOTestDataSO_06 extends CopyLinesFromOrdersTestData {
  ...
  private static String TEST_ORDERFROM1_DOCUMENTNO = "CLFOTestData6_OrderFrom1";
  private static String TEST_ORDERTO1_DOCUMENTNO = "CLFOTestData6_OrderTo1";
  ...
  private static final String SHORT_PRODUCT_NAME = "Short"
  ...
  private static final String PENCIL_PRODUCT_NAME = "Pencil"
  ...
  public void initialize() {
    ...
    order1Line2.setBusinessPartnerId(BPartnerDataConstants.CUSTOMER_A);
    order1Line2.setBusinessPartnerLocationId(BPartnerDataConstants.CUSTOMER_A_LOCATION_ID);
    order1Line2.setOrganizationId(CLFOTestConstants.SPAIN_ORGANIZATION_ID);
    order1Line2.setProductId(PENCIL_PRODUCT_WITH_NON_INSTANCE_ATTRIBUTE_ID);
    order1Line2.setAttributeSetInstanceId(ORDER_LINE_PENCIL_ATTRIBUTE_INSTANCE_ID);
    order1Line2.setUomId(CLFOTestConstants.BAG_UOM_ID);
    order1Line2.setOrderedQuantity(new BigDecimal("10"));
     ...
     */
    setExpectedOrderAmounts(new String[] { "300.00", "310.50" });
