...
public class CLFOTestDataPO_16 extends CopyLinesFromOrdersTestData {
  ...
  private static String TEST_ORDERFROM1_DOCUMENTNO = "CLFOTestData16_OrderFrom1";
  private static String TEST_ORDERTO1_DOCUMENTNO = "CLFOTestData16_OrderTo1";
  ...
  public void initialize() {
    ...
    orderFrom1.setBusinessPartnerId(BPartnerDataConstants.BEBIDAS_ALEGRES_ID);
    orderFrom1.setBusinessPartnerLocationId(BPartnerDataConstants.BEBIDAS_ALEGRES_LOCATION_ID);
    orderFrom1.setPriceListId(CLFOTestConstants.TARIFA_BEBIDAS_ALEGRES_PRICE_LIST_ID);
    orderFrom1.setOrganizationId(CLFOTestConstants.FB_ESPANA_ORGANIZATION_ID);
    ...
    order1Line1.setBusinessPartnerId(BPartnerDataConstants.BEBIDAS_ALEGRES_ID);
    order1Line1.setBusinessPartnerLocationId(BPartnerDataConstants.BEBIDAS_ALEGRES_LOCATION_ID);
    order1Line1.setOrganizationId(CLFOTestConstants.FB_ESPANA_ORGANIZATION_ID);
    ...
    orderToBeProcessed.setBusinessPartnerId(BPartnerDataConstants.BEBIDAS_ALEGRES_ID);
    orderToBeProcessed
        .setBusinessPartnerLocationId(BPartnerDataConstants.BEBIDAS_ALEGRES_LOCATION_ID);
    orderToBeProcessed.setPriceListId(CLFOTestConstants.TARIFA_BEBIDAS_ALEGRES_PRICE_LIST_ID);
    orderToBeProcessed.setOrganizationId(CLFOTestConstants.FB_ESPANA_NORTE_ORGANIZATION_ID);
     ...
     */
    setExpectedOrderAmounts(new String[] { "13.60", "16.46" });
  ...
  public String getTestDescription() {
    return "Check that created line has as organization: If the Organization of the line that is being copied belongs to the child tree of the Organization of the document header of the new line, use the organization of the line being copied, else use the organization of the document header of the new line. - First Case";
  }
