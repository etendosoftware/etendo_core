 ...
 * 
 */
public class CLFOTestDataPO_20 extends CopyLinesFromOrdersTestData {

  private static String TEST_ORDERFROM1_DOCUMENTNO = "CLFOTestData20_OrderFrom1";
  private static String TEST_ORDERTO1_DOCUMENTNO = "CLFOTestData20_OrderTo1";
  ...
  public void initialize() {
    ...
    orderFrom1.setPriceIncludingTaxes(true);
    ...
    orderFrom1.setPriceListId(CLFOTestConstants.PURCHASE_INCLUDING_TAXES_PRICE_LIST_ID);
    ...
    order1Line1.setPrice(new BigDecimal("3"));
