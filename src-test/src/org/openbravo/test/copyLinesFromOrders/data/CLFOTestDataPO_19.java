 ...
 * 
 */
public class CLFOTestDataPO_19 extends CopyLinesFromOrdersTestData {

  private static String TEST_ORDERFROM1_DOCUMENTNO = "CLFOTestData19_OrderFrom1";
  private static String TEST_ORDERTO1_DOCUMENTNO = "CLFOTestData19_OrderTo1";
  ...
  public void initialize() {
    ...
    orderToBeProcessed.setPriceIncludingTaxes(true);
    ...
    orderToBeProcessed.setPriceListId(CLFOTestConstants.PURCHASE_INCLUDING_TAXES_PRICE_LIST_ID);
     ...
     */
    setExpectedOrderAmounts(new String[] { "27.27", "30.00" });
    ...
    expectedOrderLines.put("10",
        new String[] { CLFOTestConstants.RAW_MATERIAL_A_PRODUCT_NAME, "10",
            CLFOTestConstants.BAG_UOM_NAME, "2.73", "2.73", "3.00",
