...
public class CLFOTestDataSO_08 extends CopyLinesFromOrdersTestData {
  ...
  private static String TEST_ORDERFROM1_DOCUMENTNO = "CLFOTestData8_OrderFrom1";
  private static String TEST_ORDERTO1_DOCUMENTNO = "CLFOTestData8_OrderTo1";
  ...
  public void initialize() {
    ...
    orderFrom1.setPriceListId(CLFOTestConstants.CUSTOMER_A_INCLUDING_TAXES_PRICE_LIST_ID);
