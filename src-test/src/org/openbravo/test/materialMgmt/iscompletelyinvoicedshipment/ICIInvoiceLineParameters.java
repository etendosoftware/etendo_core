...
public class ICIInvoiceLineParameters {
  ...
  public ICIInvoiceLineParameters(Invoice invoiceParam) {
    this.invoice = invoiceParam;
    this.client = invoiceParam.getClient();
    this.organization = invoiceParam.getOrganization();
    ...
    this.invoicedQuantity = new BigDecimal("10");
