...
public class ICIOrderHeaderParameters {
  ...
  public ICIOrderHeaderParameters() {
    ...
    this.warehouse = OBDal.getInstance().get(Warehouse.class, ICIConstants.WAREHOUSE_ID);
    this.invoiceTerms = ICIConstants.INVOICE_TERMS_IMMEDIATE;
