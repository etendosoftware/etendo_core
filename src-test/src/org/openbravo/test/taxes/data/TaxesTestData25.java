...
public class TaxesTestData25 extends TaxesTestData {
  ...
  public void initialize() {
    ...
    String[] lineAmounts = new String[] { "3", "2.73", "3", "2.73", "6", "5.45", "6", "5.45" };
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] amounts = new String[] { "3", "2.73", "3", "2.73", "6", "5.45", "6", "5.45" };
