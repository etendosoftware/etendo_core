...
public class TaxesTestData80 extends TaxesTestData {
  ...
  public void initialize() {
    ...
    taxes.put(TaxDataConstants.TAX_VAT_20, new String[] { "-12.40", "-2.48", "-12.40", "-2.48",
        "-24.80", "-4.96", "-24.80", "-4.96" });
    setDoctaxes(taxes);
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] amounts = new String[] { "-14.88", "-12.40", "-14.88", "-12.40", "-29.76", "-24.80",
        "-29.76", "-24.80" };
