...
public class TaxesTestData106 extends TaxesTestData {
  ...
  public void initialize() {
    ...
    line2Taxes.put(TaxDataConstants.TAX_SUPER_25, new String[] { "-14.93", "-3.73", "-14.93",
    ...
    taxes.put(TaxDataConstants.TAX_SUPER_25, new String[] { "-164.93", "-41.23", "-164.93",
        "-41.23", "-329.85", "-82.46", "-329.85", "-82.46" });
    taxes.put(TaxDataConstants.TAX_SUPER_50, new String[] { "-109.95", "-54.98", "-109.95",
        "-54.98", "-219.90", "-109.95", "-219.90", "-109.95" });
    setDoctaxes(taxes);
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] amounts = new String[] { "-206.16", "-109.95", "-206.16", "-109.95", "-412.31",
        "-219.90", "-412.31", "-219.90" };
