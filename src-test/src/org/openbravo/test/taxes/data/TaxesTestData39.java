...
public class TaxesTestData39 extends TaxesTestData {
  ...
  public void initialize() {
    ...
    lineTaxes.put(TaxDataConstants.TAX_VAT_10,
        new String[] { "1.36", "0.14", "1.36", "0.14", "2.73", "0.27", "2.73", "0.27" });
    lineTaxes.put(TaxDataConstants.TAX_EXEMPT,
        new String[] { "1.5", "0", "1.5", "0", "3", "0", "3", "0" });
    ...
    String[] lineAmounts = new String[] { "3", "2.86", "3", "2.86", "6", "5.73", "6", "5.73" };
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] amounts = new String[] { "3", "2.86", "3", "2.86", "6", "5.73", "6", "5.73" };
