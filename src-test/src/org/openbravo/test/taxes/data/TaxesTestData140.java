...
public class TaxesTestData140 extends TaxesTestData {
  ...
  public void initialize() {
    ...
    lineTaxes1.put(TaxDataConstants.TAX_VAT_4, new String[] { "-45.00", "-1.80", "-45.00", "-1.80",
        "-90.00", "-3.60", "-90.00", "-3.60" });
    ...
    String[] lineAmounts1 = new String[] { "-45.00", "-45.00", "-45.00", "-45.00", "-90.00",
        "-90.00", "-90.00", "-90.00" };
    ...
    lineTaxes2.put(TaxDataConstants.TAX_VAT_21, new String[] { "-19.80", "-4.16", "-19.80", "-4.16",
        "-39.60", "-8.32", "-39.60", "-8.32" });
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] lineAmounts2 = new String[] { "-19.80", "-19.80", "-19.80", "-19.80", "-39.60",
        "-39.60", "-39.60", "-39.60" };
    ...
    lineTaxes4.put(TaxDataConstants.TAX_VAT_21, new String[] { "-329.70", "-69.24", "-329.70",
        "-69.24", "-659.40", "-138.47", "-659.40", "-138.47" });
    ...
    lineTaxes5.put(TaxDataConstants.TAX_VAT_10, new String[] { "-331.50", "-33.15", "-331.50",
        "-33.15", "-663.00", "-66.30", "-663.00", "-66.30" });
    ...
    lineTaxes6.put(TaxDataConstants.TAX_SUPER_25, new String[] { "-11.94", "-2.99", "-11.94",
        "-2.99", "-23.88", "-5.97", "-23.88", "-5.97" });
    ...
    lineTaxes11.put(TaxDataConstants.TAX_IEPS_53_16, new String[] { "-1354.00", "-216.64",
        "-1354.00", "-216.64", "-2708.01", "-433.28", "-2708.01", "-433.28" });
    ...
    lineTaxes12.put(TaxDataConstants.TAX_IEPS_53_16, new String[] { "-1170.22", "-187.24",
        "-1170.22", "-187.24", "-2340.44", "-374.47", "-2340.44", "-374.47" });
    ...
    lineTaxes13.put(TaxDataConstants.TAX_IEPS_53_16, new String[] { "-1374.06", "-219.85",
        "-1374.06", "-219.85", "-2748.12", "-439.70", "-2748.12", "-439.70" });
    ...
    taxes.put(TaxDataConstants.TAX_VAT_4, new String[] { "-45.00", "-1.80", "-45.00", "-1.80",
        "-90.00", "-3.60", "-90.00", "-3.60" });
    taxes.put(TaxDataConstants.TAX_SUPER_25, new String[] { "-20.88", "-5.23", "-20.88", "-5.23",
        "-41.76", "-10.44", "-41.76", "-10.44" });
    taxes.put(TaxDataConstants.TAX_SUPER_50, new String[] { "-13.92", "-6.96", "-13.92", "-6.96",
        "-27.84", "-13.92", "-27.84", "-13.92" });
    taxes.put(TaxDataConstants.TAX_IEPS_26_16, new String[] { "-847.05", "-135.53", "-847.05",
        "-135.53", "-1694.09", "-271.05", "-1694.09", "-271.05" });
    taxes.put(TaxDataConstants.TAX_IEPS_26_26, new String[] { "-669.60", "-177.45", "-669.60",
        "-177.45", "-1339.20", "-354.89", "-1339.20", "-354.89" });
    taxes.put(TaxDataConstants.TAX_IEPS_53_16, new String[] { "-3898.28", "-623.73", "-3898.28",
        "-623.73", "-7796.57", "-1247.45", "-7796.57", "-1247.45" });
    taxes.put(TaxDataConstants.TAX_IEPS_53_53, new String[] { "-2547.90", "-1350.38", "-2547.90",
        "-1350.38", "-5095.80", "-2700.77", "-5095.80", "-2700.77" });
    setDoctaxes(taxes);
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] amounts = new String[] { "-6374.29", "-3965.82", "-6374.29", "-3965.82", "-12748.53",
