...
public class TaxesTestData95 extends TaxesTestData {
  ...
  public void initialize() {
    ...
    lineTaxes1.put(TaxDataConstants.TAX_VAT_4,
        new String[] { "72.12", "2.88", "72.12", "2.88", "144.23", "5.77", "144.23", "5.77" });
    ...
    String[] lineAmounts1 = new String[] { "75.00", "72.12", "75.00", "72.12", "150.00", "144.23",
        "150.00", "144.23" };
    ...
    lineTaxes2.put(TaxDataConstants.TAX_VAT_21,
        new String[] { "40.91", "8.59", "40.91", "8.59", "81.82", "17.18", "81.82", "17.18" });
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] lineAmounts2 = new String[] { "49.50", "40.91", "49.50", "40.91", "99.00", "81.82",
        "99.00", "81.82" };
    ...
    lineTaxes4.put(TaxDataConstants.TAX_VAT_21,
        new String[] { "26.78", "5.62", "26.78", "5.62", "53.55", "11.25", "53.55", "11.25" });
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] lineAmounts4 = new String[] { "32.40", "26.78", "32.40", "26.78", "64.80", "53.55",
        "64.80", "53.55" };
    ...
    taxes.put(TaxDataConstants.TAX_VAT_21,
        new String[] { "67.69", "14.21", "67.69", "14.21", "135.37", "28.43", "135.37", "28.43" });
    taxes.put(TaxDataConstants.TAX_VAT_10, new String[] { "408.37", "40.83", "408.37", "40.83",
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] amounts = new String[] { "606.10", "548.18", "606.10", "548.18", "1212.20", "1096.33",
        "1212.20", "1096.33" };
