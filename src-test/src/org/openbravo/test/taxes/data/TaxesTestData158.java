...
public class TaxesTestData158 extends TaxesTestData {
  ...
  public void initialize() {
    ...
    lineTaxes1.put(TaxDataConstants.TAX_VAT_4, new String[] { "-576.92", "-23.08", "-576.92",
        "-23.08", "-1153.85", "-46.15", "-1153.85", "-46.15" });
    ...
    lineTaxes2.put(TaxDataConstants.TAX_VAT_21, new String[] { "-245.45", "-51.55", "-245.45",
        "-51.55", "-490.91", "-103.09", "-490.91", "-103.09" });
    ...
    lineTaxes3.put(TaxDataConstants.TAX_VAT_10, new String[] { "-87.27", "-8.73", "-87.27", "-8.73",
        "-174.55", "-17.45", "-174.55", "-17.45" });
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] lineAmounts3 = new String[] { "-96.00", "-87.27", "-96.00", "-87.27", "-192.00",
        "-174.55", "-192.00", "-174.55" };
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] lineAmounts4 = new String[] { "-4396.00", "-3633.06", "-4396.00", "-3633.06",
        "-8792.00", "-7266.12", "-8792.00", "-7266.11" };
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] lineAmounts5 = new String[] { "-4420.00", "-4018.18", "-4420.00", "-4018.18",
        "-8840.00", "-8036.36", "-8840.00", "-8036.36" };
    ...
    lineTaxes6.put(TaxDataConstants.TAX_SUPER_25, new String[] { "-79.60", "-19.90", "-79.60",
        "-19.90", "-159.20", "-39.80", "-159.20", "-39.80" });
    lineTaxes6.put(TaxDataConstants.TAX_SUPER_50, new String[] { "-53.07", "-26.53", "-53.07",
        "-26.53", "-106.13", "-53.07", "-106.13", "-53.07" });
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] lineAmounts6 = new String[] { "-99.50", "-53.07", "-99.50", "-53.07", "-199.00",
        "-106.13", "-199.00", "-106.13" };
    ...
    lineTaxes7.put(TaxDataConstants.TAX_SUPER_25, new String[] { "-59.60", "-14.90", "-59.60",
        "-14.90", "-119.20", "-29.80", "-119.20", "-29.80" });
    lineTaxes7.put(TaxDataConstants.TAX_SUPER_50, new String[] { "-39.73", "-19.87", "-39.73",
        "-19.87", "-79.47", "-39.73", "-79.47", "-39.73" });
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] lineAmounts7 = new String[] { "-74.50", "-39.73", "-74.50", "-39.73", "-149.00",
        "-79.47", "-149.00", "-79.47" };
    ...
    lineTaxes8.put(TaxDataConstants.TAX_IEPS_26_16, new String[] { "-1924.14", "-307.86",
        "-1924.14", "-307.86", "-3848.28", "-615.72", "-3848.28", "-615.72" });
    lineTaxes8.put(TaxDataConstants.TAX_IEPS_26_26, new String[] { "-1521.06", "-403.08",
        "-1521.06", "-403.08", "-3042.12", "-806.16", "-3042.12", "-806.16" });
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] lineAmounts8 = new String[] { "-2232.00", "-1521.06", "-2232.00", "-1521.06",
        "-4464.00", "-3042.12", "-4464.00", "-3042.12" };
    ...
    lineTaxes9.put(TaxDataConstants.TAX_IEPS_26_16, new String[] { "-2405.17", "-384.83",
        "-2405.17", "-384.83", "-4810.34", "-769.66", "-4810.34", "-769.66" });
    lineTaxes9.put(TaxDataConstants.TAX_IEPS_26_26, new String[] { "-1901.32", "-503.85",
        "-1901.32", "-503.85", "-3802.64", "-1007.70", "-3802.64", "-1007.70" });
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] lineAmounts9 = new String[] { "-2790.00", "-1901.32", "-2790.00", "-1901.32",
        "-5580.00", "-3802.64", "-5580.00", "-3802.64" };
    ...
    lineTaxes10.put(TaxDataConstants.TAX_IEPS_26_16, new String[] { "-2886.21", "-461.79",
        "-2886.21", "-461.79", "-5772.41", "-923.59", "-5772.41", "-923.59" });
    lineTaxes10.put(TaxDataConstants.TAX_IEPS_26_26, new String[] { "-2281.59", "-604.62",
        "-2281.59", "-604.62", "-4563.17", "-1209.24", "-4563.17", "-1209.24" });
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] lineAmounts10 = new String[] { "-3348.00", "-2281.59", "-3348.00", "-2281.59",
        "-6696.00", "-4563.17", "-6696.00", "-4563.17" };
    ...
    lineTaxes11.put(TaxDataConstants.TAX_IEPS_53_53, new String[] { "-6648.41", "-3523.66",
        "-6648.41", "-3523.66", "-13296.82", "-7047.32", "-13296.82", "-7047.32" });
    ...
    lineTaxes12.put(TaxDataConstants.TAX_IEPS_53_16, new String[] { "-8791.38", "-1406.62",
        "-8791.38", "-1406.62", "-17582.76", "-2813.24", "-17582.76", "-2813.24" });
    lineTaxes12.put(TaxDataConstants.TAX_IEPS_53_53, new String[] { "-5746.00", "-3045.38",
        "-5746.00", "-3045.38", "-11492.00", "-6090.76", "-11492.00", "-6090.76" });
    ...
    lineTaxes13.put(TaxDataConstants.TAX_IEPS_53_53, new String[] { "-6746.90", "-3575.86",
        "-6746.90", "-3575.86", "-13493.80", "-7151.72", "-13493.80", "-7151.72" });
    ...
    taxes.put(TaxDataConstants.TAX_VAT_21, new String[] { "-3878.51", "-814.49", "-3878.51",
        "-814.49", "-7757.02", "-1628.97", "-7757.02", "-1628.98" });
    taxes.put(TaxDataConstants.TAX_VAT_10, new String[] { "-4105.45", "-410.55", "-4105.45",
        "-410.55", "-8210.91", "-821.09", "-8210.91", "-821.09" });
    taxes.put(TaxDataConstants.TAX_SUPER_25, new String[] { "-139.20", "-34.80", "-139.20",
        "-34.80", "-278.40", "-69.60", "-278.40", "-69.60" });
    taxes.put(TaxDataConstants.TAX_SUPER_50, new String[] { "-92.80", "-46.40", "-92.80", "-46.40",
        "-185.60", "-92.80", "-185.60", "-92.80" });
    taxes.put(TaxDataConstants.TAX_IEPS_26_16, new String[] { "-7215.52", "-1154.48", "-7215.52",
        "-1154.48", "-14431.03", "-2308.96", "-14431.03", "-2308.97" });
    taxes.put(TaxDataConstants.TAX_IEPS_26_26, new String[] { "-5703.97", "-1511.55", "-5703.97",
        "-1511.55", "-11407.93", "-3023.10", "-11407.93", "-3023.10" });
    taxes.put(TaxDataConstants.TAX_IEPS_53_16, new String[] { "-29286.20", "-4685.79", "-29286.21",
        "-4685.79", "-58572.41", "-9371.59", "-58572.41", "-9371.59" });
    taxes.put(TaxDataConstants.TAX_IEPS_53_53, new String[] { "-19141.31", "-10144.89", "-19141.31",
        "-10144.90", "-38282.62", "-20289.79", "-38282.62", "-20289.79" });
    setDoctaxes(taxes);
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] amounts = new String[] { "-52325.00", "-33498.96", "-52325.00", "-33498.96",
        "-104650.00", "-66997.93", "-104650.00", "-66997.93" };
