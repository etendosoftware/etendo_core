...
public class TaxesTestData101 extends TaxesTestData {
  ...
  public void initialize() {
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] lineAmounts7 = new String[] { "1.49", "0.79", "1.49", "0.82", "2.98", "1.59", "2.98",
        "1.59" };
    ...
    // In Hibernate 6, document-level tax calculations produce slightly different results due to
    // changes in how rounding is applied during aggregation of line-level amounts.
    // 
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] amounts = new String[] { "10.43", "5.56", "10.43", "5.56", "20.86", "11.13", "20.86",
        "11.13" };
