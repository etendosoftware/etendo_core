...
public class TaxesTestData97 extends TaxesTestData {
  ...
  public void initialize() {
    ...
    taxes.put(TaxDataConstants.TAX_SUPER_25,
        new String[] { "15.65", "3.91", "15.65", "3.91", "31.29", "7.82", "31.29", "7.82" });
    taxes.put(TaxDataConstants.TAX_SUPER_50,
        new String[] { "10.43", "5.22", "10.43", "5.22", "20.86", "10.43", "20.86", "10.43" });
    setDoctaxes(taxes);
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] amounts = new String[] { "19.56", "10.43", "19.56", "10.43", "39.11", "20.86", "39.11",
        "20.86" };
