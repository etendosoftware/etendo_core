...
public class TaxesTestData113 extends TaxesTestData {
  ...
  public void initialize() {
    ...
    taxes.put(TaxDataConstants.TAX_SUPER_25,
        new String[] { "97.37", "24.34", "97.37", "24.34", "194.73", "48.68", "194.73", "48.68" });
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] amounts = new String[] { "121.71", "64.91", "121.71", "64.91", "243.41", "129.82",
        "243.41", "129.82" };
