...
public class TaxesTestData189 extends TaxesTestData {
  ...
  public void initialize() {
    ...
    lineTaxes1.put(TaxDataConstants.TAX_VAT_20, new String[] { "298.33", "59.66", "298.33", "59.66",
        "596.65", "119.33", "596.65", "119.33" });
    ...
    String[] lineAmounts1 = new String[] { "357.99", "298.33", "357.99", "298.32", "715.98",
    ...
    taxes.put(TaxDataConstants.TAX_VAT_20, new String[] { "298.33", "59.67", "268.49", "53.70",
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] amounts = new String[] { "357.99", "298.33", "322.19", "268.49", "715.98", "596.65",
        "644.38", "536.98" };
