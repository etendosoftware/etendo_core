...
public class TaxesTestData146 extends TaxesTestData {
  ...
  public void initialize() {
    ...
    taxes.put(TaxDataConstants.TAX_VAT_4, new String[] { "-60.00", "-2.40", "-60.00", "-2.40",
        "-120.00", "-4.80", "-120.00", "-4.80" });
    taxes.put(TaxDataConstants.TAX_SUPER_25, new String[] { "-26.10", "-6.53", "-26.10", "-6.53",
        "-52.20", "-13.05", "-52.20", "-13.05" });
    taxes.put(TaxDataConstants.TAX_SUPER_50, new String[] { "-17.40", "-8.70", "-17.40", "-8.70",
