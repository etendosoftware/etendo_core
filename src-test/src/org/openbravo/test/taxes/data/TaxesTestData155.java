...
public class TaxesTestData155 extends TaxesTestData {
  ...
  public void initialize() {
    ...
    lineTaxes1.put(TaxDataConstants.TAX_VAT_4, new String[] { "600.00", "24.00", "600.00", "24.00",
    ...
    lineTaxes2.put(TaxDataConstants.TAX_VAT_21, new String[] { "297.00", "62.37", "297.00", "62.37",
        "594.00", "124.74", "594.00", "124.74" });
    ...
    lineTaxes3.put(TaxDataConstants.TAX_VAT_10,
        new String[] { "96.00", "9.60", "96.00", "9.60", "192.00", "19.20", "192.00", "19.20" });
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] lineAmounts3 = new String[] { "96.00", "96.00", "96.00", "96.00", "192.00", "192.00",
        "192.00", "192.00" };
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] lineAmounts4 = new String[] { "4396.00", "4396.00", "4396.00", "4396.00", "8792.00",
        "8792.00", "8792.00", "8792.00" };
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] lineAmounts5 = new String[] { "4420.00", "4420.00", "4420.00", "4420.00", "8840.00",
        "8840.00", "8840.00", "8840.00" };
    ...
    lineTaxes6.put(TaxDataConstants.TAX_SUPER_50,
        new String[] { "99.50", "49.75", "99.50", "49.75", "199.00", "99.50", "199.00", "99.50" });
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] lineAmounts6 = new String[] { "99.50", "99.50", "99.50", "99.50", "199.00", "199.00",
        "199.00", "199.00" };
    ...
    lineTaxes7.put(TaxDataConstants.TAX_SUPER_50,
        new String[] { "74.50", "37.25", "74.50", "37.25", "149.00", "74.50", "149.00", "74.50" });
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] lineAmounts7 = new String[] { "74.50", "74.50", "74.50", "74.50", "149.00", "149.00",
        "149.00", "149.00" };
    ...
    lineTaxes8.put(TaxDataConstants.TAX_IEPS_26_16, new String[] { "2823.48", "451.76", "2823.48",
        "451.76", "5646.96", "903.51", "5646.96", "903.51" });
    lineTaxes8.put(TaxDataConstants.TAX_IEPS_26_26, new String[] { "2232.00", "591.48", "2232.00",
        "591.48", "4464.00", "1182.96", "4464.00", "1182.96" });
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] lineAmounts8 = new String[] { "2232.00", "2232.00", "2232.00", "2232.00", "4464.00",
        "4464.00", "4464.00", "4464.00" };
    ...
    lineTaxes9.put(TaxDataConstants.TAX_IEPS_26_16, new String[] { "3529.35", "564.70", "3529.35",
        "564.70", "7058.70", "1129.39", "7058.70", "1129.39" });
    lineTaxes9.put(TaxDataConstants.TAX_IEPS_26_26, new String[] { "2790.00", "739.35", "2790.00",
        "739.35", "5580.00", "1478.70", "5580.00", "1478.70" });
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] lineAmounts9 = new String[] { "2790.00", "2790.00", "2790.00", "2790.00", "5580.00",
        "5580.00", "5580.00", "5580.00" };
    ...
    lineTaxes10.put(TaxDataConstants.TAX_IEPS_26_16, new String[] { "4235.22", "677.64", "4235.22",
        "677.64", "8470.44", "1355.27", "8470.44", "1355.27" });
    lineTaxes10.put(TaxDataConstants.TAX_IEPS_26_26, new String[] { "3348.00", "887.22", "3348.00",
        "887.22", "6696.00", "1774.44", "6696.00", "1774.44" });
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] lineAmounts10 = new String[] { "3348.00", "3348.00", "3348.00", "3348.00", "6696.00",
        "6696.00", "6696.00", "6696.00" };
    ...
    taxes.put(TaxDataConstants.TAX_VAT_21, new String[] { "4693.00", "985.53", "4693.00", "985.53",
        "9386.00", "1971.06", "9386.00", "1971.06" });
    taxes.put(TaxDataConstants.TAX_VAT_10, new String[] { "4516.00", "451.60", "4516.00", "451.60",
        "9032.00", "903.20", "9032.00", "903.20" });
    taxes.put(TaxDataConstants.TAX_VAT_4, new String[] { "600.00", "24.00", "600.00", "24.00",
        "1200.00", "48.00", "1200.00", "48.00" });
    taxes.put(TaxDataConstants.TAX_SUPER_25, new String[] { "261.00", "65.25", "261.00", "65.25",
        "522.00", "130.51", "522.00", "130.51" });
    taxes.put(TaxDataConstants.TAX_SUPER_50, new String[] { "174.00", "87.00", "174.00", "87.00",
        "348.00", "174.00", "348.00", "174.00" });
    taxes.put(TaxDataConstants.TAX_IEPS_26_16, new String[] { "10588.05", "1694.10", "10588.05",
        "1694.10", "21176.10", "3388.17", "21176.10", "3388.17" });
    taxes.put(TaxDataConstants.TAX_IEPS_26_26, new String[] { "8370.00", "2218.05", "8370.00",
        "2218.05", "16740.00", "4436.10", "16740.00", "4436.10" });
    taxes.put(TaxDataConstants.TAX_IEPS_53_16, new String[] { "51977.16", "8316.34", "51977.16",
        "8316.34", "103954.32", "16632.69", "103954.32", "16632.69" });
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] amounts = new String[] { "84172.03", "52325.00", "84172.03", "52325.00", "168344.05",
        "104650.00", "168344.05", "104650.00" };
