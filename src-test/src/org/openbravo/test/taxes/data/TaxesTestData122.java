...
public class TaxesTestData122 extends TaxesTestData {
  ...
  public void initialize() {
    ...
    taxes.put(TaxDataConstants.TAX_IEPS_53_16, new String[] { "-432709.86", "-69233.58",
        "-432709.86", "-69233.58", "-865419.71", "-138467.15", "-865419.71", "-138467.15" });
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] amounts = new String[] { "-501943.44", "-282816.90", "-501943.44", "-282816.90",
        "-1003886.86", "-565633.80", "-1003886.86", "-565633.80" };
