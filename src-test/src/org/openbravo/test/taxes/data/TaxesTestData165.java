...
public class TaxesTestData165 extends TaxesTestData {
  ...
  public void initialize() {
    ...
    lineTaxes.put(TaxDataConstants.TAX_VAT_20, new String[] { "298.33", "59.66", "298.33", "59.66",
    ...
    String[] lineAmounts = new String[] { "357.99", "298.33", "357.99", "298.33", "715.98",
    ...
    taxes.put(TaxDataConstants.TAX_VAT_20, new String[] { "298.33", "59.67", "298.33", "59.66",
        "596.65", "119.33", "596.65", "119.33" });
    setDoctaxes(taxes);
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] amounts = new String[] { "357.99", "298.33", "357.99", "298.33", "715.98", "596.65",
        "715.98", "596.65" };
