...
public class TaxesTestData131 extends TaxesTestData {
  ...
  public void initialize() {
    ...
    lineTaxes5.put(TaxDataConstants.TAX_IEPS_53_16, new String[] { "4680.88", "748.94", "4680.88",
        "748.94", "9361.76", "1497.88", "9361.76", "1497.88" });
    lineTaxes5.put(TaxDataConstants.TAX_IEPS_53_53, new String[] { "3059.40", "1621.48", "3059.40",
        "1621.48", "6118.80", "3242.96", "6118.80", "3242.96" });
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] lineAmounts5 = new String[] { "3059.40", "3059.40", "3059.40", "3059.40", "6118.80",
        "6118.80", "6118.80", "6118.80" };
    ...
    taxes.put(TaxDataConstants.TAX_IEPS_26_16, new String[] { "186349.68", "29815.94", "186349.68",
        "29815.94", "372699.36", "59631.90", "372699.36", "59631.90" });
    taxes.put(TaxDataConstants.TAX_IEPS_26_26, new String[] { "147312.00", "39037.68", "147312.00",
        "39037.68", "294624.00", "78075.36", "294624.00", "78075.36" });
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] amounts = new String[] { "260093.67", "172062.99", "260093.67", "172062.99",
