...
public class TaxesTestData199 extends TaxesTestData {
  ...
  public void initialize() {
    ...
    lineTaxes2.put(TaxDataConstants.TAX_VAT_20,
        new String[] { "0.00", "0.00", "-298.33", "-59.66", "0.00", "0.00", "-596.65", "-119.33" });
    ...
    taxes.put(TaxDataConstants.TAX_VAT_20,
        new String[] { "298.33", "59.66", "0", "0", "596.65", "119.33", "0", "0" });
    setDoctaxes(taxes);
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] amounts = new String[] { "357.99", "298.33", "0", "0", "715.98", "596.65", "0", "0" };
