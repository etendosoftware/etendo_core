...
public class TaxesTestData168 extends TaxesTestData {
  ...
  public void initialize() {
    ...
    lineTaxes.put(TaxDataConstants.TAX_VAT_20, new String[] { "-298.33", "-59.66", "-298.33",
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] amounts = new String[] { "-357.99", "-298.33", "-357.99", "-298.33", "-715.98",
        "-596.65", "-715.98", "-596.65" };
