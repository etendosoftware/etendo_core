...
public class TaxesTestData100 extends TaxesTestData {
  ...
  public void initialize() {
    ...
    taxes.put(TaxDataConstants.TAX_SUPER_25, new String[] { "-15.68", "-3.92", "-15.68", "-3.92",
        "-31.29", "-7.84", "-31.29", "-7.84" });
    taxes.put(TaxDataConstants.TAX_SUPER_50, new String[] { "-10.43", "-5.25", "-10.43", "-5.25",
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] amounts = new String[] { "-19.60", "-10.43", "-19.60", "-10.43", "-39.13", "-20.86",
        "-39.13", "-20.86" };
