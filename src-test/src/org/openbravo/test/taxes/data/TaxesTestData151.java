...
public class TaxesTestData151 extends TaxesTestData {
  ...
  public void initialize() {
    ...
    lineTaxes1.put(TaxDataConstants.TAX_VAT_4,
        new String[] { "57.69", "2.31", "57.69", "2.31", "115.38", "4.62", "115.38", "4.62" });
    ...
    String[] lineAmounts1 = new String[] { "60.00", "57.69", "60.00", "57.69", "120.00", "115.38",
        "120.00", "115.38" };
    ...
    lineTaxes2.put(TaxDataConstants.TAX_VAT_21,
        new String[] { "24.55", "5.15", "24.55", "5.15", "49.09", "10.31", "49.09", "10.31" });
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] lineAmounts2 = new String[] { "29.70", "24.55", "29.70", "24.55", "59.40", "49.09",
        "59.40", "49.09" };
    ...
    lineTaxes4.put(TaxDataConstants.TAX_VAT_21, new String[] { "363.31", "76.29", "363.31", "76.29",
        "726.61", "152.59", "726.61", "152.59" });
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] lineAmounts4 = new String[] { "439.60", "363.31", "439.60", "363.31", "879.20",
    ...
    lineTaxes5.put(TaxDataConstants.TAX_VAT_10, new String[] { "401.82", "40.18", "401.82", "40.18",
        "803.64", "80.36", "803.64", "80.36" });
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] lineAmounts7 = new String[] { "7.45", "3.97", "7.45", "3.97", "14.90", "7.95", "14.90",
        "7.95" };
    ...
    lineTaxes11.put(TaxDataConstants.TAX_IEPS_53_16, new String[] { "1017.21", "162.75", "1017.21",
        "162.75", "2034.41", "325.51", "2034.41", "325.51" });
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] lineAmounts11 = new String[] { "1179.96", "664.84", "1179.96", "664.84", "2359.92",
        "1329.68", "2359.92", "1329.68" };
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] lineAmounts12 = new String[] { "1019.80", "574.60", "1019.80", "574.60", "2039.60",
        "1149.20", "2039.60", "1149.20" };
    ...
    lineTaxes13.put(TaxDataConstants.TAX_IEPS_53_16, new String[] { "1032.28", "165.16", "1032.28",
        "165.16", "2064.55", "330.33", "2064.55", "330.33" });
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] lineAmounts13 = new String[] { "1197.44", "674.69", "1197.44", "674.69", "2394.88",
        "1349.38", "2394.88", "1349.38" };
    ...
    taxes.put(TaxDataConstants.TAX_VAT_4,
        new String[] { "57.69", "2.31", "57.69", "2.31", "115.38", "4.62", "115.38", "4.62" });
    taxes.put(TaxDataConstants.TAX_VAT_21, new String[] { "387.86", "81.44", "387.86", "81.44",
        "775.70", "162.90", "775.70", "162.90" });
    taxes.put(TaxDataConstants.TAX_VAT_10, new String[] { "410.55", "41.05", "410.55", "41.05",
        "821.09", "82.11", "821.09", "82.11" });
    taxes.put(TaxDataConstants.TAX_SUPER_25,
        new String[] { "13.92", "3.48", "13.92", "3.48", "27.84", "6.96", "27.84", "6.96" });
    ...
    taxes.put(TaxDataConstants.TAX_IEPS_53_53, new String[] { "1914.13", "1014.50", "1914.13",
        "1014.50", "3828.26", "2028.98", "3828.26", "2028.98" });
    setDoctaxes(taxes);
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] amounts = new String[] { "5232.50", "3349.91", "5232.50", "3349.91", "10465.00",
