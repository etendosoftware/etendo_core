...
public class TaxesTestData126 extends TaxesTestData {
  ...
  public void initialize() {
    ...
    taxes.put(TaxDataConstants.TAX_IEPS_53_16, new String[] { "-243807.67", "-39009.23",
        "-243807.67", "-39009.23", "-487615.35", "-78018.46", "-487615.34", "-78018.46" });
    taxes.put(TaxDataConstants.TAX_IEPS_53_53, new String[] { "-159351.42", "-84456.25",
        "-159351.42", "-84456.25", "-318702.84", "-168912.51", "-318702.84", "-168912.50" });
    setDoctaxes(taxes);
