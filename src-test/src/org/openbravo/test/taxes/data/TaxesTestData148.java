...
public class TaxesTestData148 extends TaxesTestData {
  ...
  public void initialize() {
    ...
    lineTaxes1.put(TaxDataConstants.TAX_VAT_4, new String[] { "-60.00", "-2.40", "-60.00", "-2.40",
        "-120.00", "-4.80", "-120.00", "-4.80" });
    ...
    String[] lineAmounts1 = new String[] { "-60.00", "-60.00", "-60.00", "-60.00", "-120.00",
    ...
    lineTaxes2.put(TaxDataConstants.TAX_VAT_21, new String[] { "-29.70", "-6.24", "-29.70", "-6.24",
        "-59.40", "-12.47", "-59.40", "-12.47" });
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] lineAmounts2 = new String[] { "-29.70", "-29.70", "-29.70", "-29.70", "-59.40",
        "-59.40", "-59.40", "-59.40" };
    ...
    lineTaxes4.put(TaxDataConstants.TAX_VAT_21, new String[] { "-439.60", "-92.32", "-439.60",
        "-92.32", "-879.20", "-184.63", "-879.20", "-184.63" });
    ...
    lineTaxes6.put(TaxDataConstants.TAX_SUPER_25, new String[] { "-14.93", "-3.73", "-14.93",
        "-3.73", "-29.85", "-7.46", "-29.85", "-7.46" });
    ...
    lineTaxes7.put(TaxDataConstants.TAX_SUPER_25, new String[] { "-11.18", "-2.80", "-11.18",
        "-2.80", "-22.35", "-5.59", "-22.35", "-5.59" });
    ...
    lineTaxes11.put(TaxDataConstants.TAX_IEPS_53_16, new String[] { "-1805.34", "-288.85",
        "-1805.34", "-288.85", "-3610.68", "-577.71", "-3610.68", "-577.71" });
    lineTaxes11.put(TaxDataConstants.TAX_IEPS_53_53, new String[] { "-1179.96", "-625.38",
        "-1179.96", "-625.38", "-2359.92", "-1250.76", "-2359.92", "-1250.76" });
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] lineAmounts11 = new String[] { "-1179.96", "-1179.96", "-1179.96", "-1179.96",
        "-2359.92", "-2359.92", "-2359.92", "-2359.92" };
    ...
    lineTaxes12.put(TaxDataConstants.TAX_IEPS_53_16, new String[] { "-1560.29", "-249.65",
        "-1560.29", "-249.65", "-3120.59", "-499.29", "-3120.59", "-499.29" });
    lineTaxes12.put(TaxDataConstants.TAX_IEPS_53_53, new String[] { "-1019.80", "-540.49",
        "-1019.80", "-540.49", "-2039.60", "-1080.99", "-2039.60", "-1080.99" });
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] lineAmounts12 = new String[] { "-1019.80", "-1019.80", "-1019.80", "-1019.80",
        "-2039.60", "-2039.60", "-2039.60", "-2039.60" };
    ...
    lineTaxes13.put(TaxDataConstants.TAX_IEPS_53_16, new String[] { "-1832.08", "-293.13",
        "-1832.08", "-293.13", "-3664.17", "-586.27", "-3664.17", "-586.27" });
    lineTaxes13.put(TaxDataConstants.TAX_IEPS_53_53, new String[] { "-1197.44", "-634.64",
        "-1197.44", "-634.64", "-2394.88", "-1269.29", "-2394.88", "-1269.29" });
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] lineAmounts13 = new String[] { "-1197.44", "-1197.44", "-1197.44", "-1197.44",
        "-2394.88", "-2394.88", "-2394.88", "-2394.88" };
    ...
    taxes.put(TaxDataConstants.TAX_VAT_21, new String[] { "-469.30", "-98.56", "-469.30", "-98.56",
        "-938.60", "-197.10", "-938.60", "-197.10" });
    taxes.put(TaxDataConstants.TAX_VAT_10, new String[] { "-451.60", "-45.16", "-451.60", "-45.16",
        "-903.20", "-90.32", "-903.20", "-90.32" });
    taxes.put(TaxDataConstants.TAX_VAT_4, new String[] { "-60.00", "-2.40", "-60.00", "-2.40",
        "-120.00", "-4.80", "-120.00", "-4.80" });
    taxes.put(TaxDataConstants.TAX_SUPER_25, new String[] { "-26.11", "-6.53", "-26.11", "-6.53",
        "-52.20", "-13.05", "-52.20", "-13.05" });
    taxes.put(TaxDataConstants.TAX_SUPER_50, new String[] { "-17.40", "-8.71", "-17.40", "-8.71",
        "-34.80", "-17.40", "-34.80", "-17.40" });
    ...
    taxes.put(TaxDataConstants.TAX_IEPS_53_16, new String[] { "-5197.71", "-831.63", "-5197.71",
        "-831.63", "-10395.44", "-1663.27", "-10395.44", "-1663.27" });
    taxes.put(TaxDataConstants.TAX_IEPS_53_53, new String[] { "-3397.20", "-1800.51", "-3397.20",
        "-1800.51", "-6794.40", "-3601.04", "-6794.40", "-3601.04" });
    setDoctaxes(taxes);
