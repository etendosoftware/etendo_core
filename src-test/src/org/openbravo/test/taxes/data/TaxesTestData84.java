...
public class TaxesTestData84 extends TaxesTestData {
  ...
  public void initialize() {
    ...
    taxes.put(TaxDataConstants.TAX_VAT_20, new String[] { "-10.33", "-2.07", "-10.33", "-2.07",
        "-20.67", "-4.13", "-20.67", "-4.13" });
    setDoctaxes(taxes);
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] amounts = new String[] { "-12.40", "-10.33", "-12.40", "-10.33", "-24.80", "-20.67",
        "-24.80", "-20.67" };
