...
public class TaxesTestData91 extends TaxesTestData {
  ...
  public void initialize() {
    ...
    lineTaxes1.put(TaxDataConstants.TAX_VAT_4,
        new String[] { "75.00", "3.00", "75.00", "3.00", "150.00", "6.00", "150.00", "6.00" });
    ...
    String[] lineAmounts1 = new String[] { "75.00", "75.00", "75.00", "75.00", "150.00", "150.00",
        "150.00", "150.00" };
    ...
    lineTaxes2.put(TaxDataConstants.TAX_VAT_21,
        new String[] { "49.50", "10.40", "49.50", "10.40", "99.00", "20.79", "99.00", "20.79" });
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] lineAmounts2 = new String[] { "49.50", "49.50", "49.50", "49.50", "99.00", "99.00",
        "99.00", "99.00" };
    ...
    lineTaxes4.put(TaxDataConstants.TAX_VAT_21,
        new String[] { "32.40", "6.80", "32.40", "6.80", "64.80", "13.61", "64.80", "13.61" });
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] lineAmounts4 = new String[] { "32.40", "32.40", "32.40", "32.40", "64.80", "64.80",
        "64.80", "64.80" };
    ...
    taxes.put(TaxDataConstants.TAX_VAT_21,
        new String[] { "81.90", "17.20", "81.90", "17.20", "163.80", "34.40", "163.80", "34.40" });
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] amounts = new String[] { "671.22", "606.10", "671.22", "606.10", "1342.44", "1212.20",
        "1342.44", "1212.20" };
