...
public class TaxesTestData104 extends TaxesTestData {
  ...
  public void initialize() {
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] lineAmounts7 = new String[] { "-1.49", "-0.79", "-1.49", "-0.79", "-2.98", "-1.59",
        "-2.98", "-1.59" };
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] amounts = new String[] { "-10.43", "-5.53", "-10.43", "-5.53", "-20.86", "-11.13",
        "-20.86", "-11.13" };
