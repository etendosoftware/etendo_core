...
public class TaxesTestData135 extends TaxesTestData {
  ...
  public void initialize() {
    ...
    String[] lineAmounts1 = new String[] { "66960.00", "45631.73", "66960.00", "45631.73",
    ...
    lineTaxes4.put(TaxDataConstants.TAX_IEPS_53_16, new String[] { "9409.16", "1505.47", "9409.16",
        "1505.47", "18818.33", "3010.93", "18818.33", "3010.93" });
    lineTaxes4.put(TaxDataConstants.TAX_IEPS_53_53, new String[] { "6149.78", "3259.38", "6149.78",
        "3259.38", "12299.56", "6518.77", "12299.56", "6518.77" });
    ...
    lineTaxes5.put(TaxDataConstants.TAX_IEPS_53_16, new String[] { "2637.41", "421.99", "2637.41",
        "421.99", "5274.83", "843.97", "5274.83", "843.97" });
    lineTaxes5.put(TaxDataConstants.TAX_IEPS_53_53, new String[] { "1723.80", "913.61", "1723.80",
        "913.61", "3447.60", "1827.23", "3447.60", "1827.23" });
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] lineAmounts5 = new String[] { "3059.40", "1723.80", "3059.40", "1723.80", "6118.80",
        "3447.60", "6118.80", "3447.60" };
    ...
    lineTaxes6.put(TaxDataConstants.TAX_IEPS_53_16, new String[] { "9290.48", "1486.48", "9290.48",
        "1486.48", "18580.96", "2972.96", "18580.96", "2972.96" });
    lineTaxes6.put(TaxDataConstants.TAX_IEPS_53_53, new String[] { "6072.21", "3218.27", "6072.21",
        "3218.27", "12144.42", "6436.54", "12144.42", "6436.54" });
    ...
    taxes.put(TaxDataConstants.TAX_IEPS_26_16, new String[] { "126993.11", "20318.89", "126993.11",
        "20318.89", "253986.21", "40637.79", "253986.21", "40637.79" });
    taxes.put(TaxDataConstants.TAX_IEPS_26_26, new String[] { "100389.80", "26603.31", "100389.80",
        "26603.31", "200779.61", "53206.60", "200779.61", "53206.60" });
    taxes.put(TaxDataConstants.TAX_IEPS_53_16, new String[] { "21337.05", "3413.94", "21337.05",
        "3413.94", "42674.12", "6827.86", "42674.12", "6827.86" });
    taxes.put(TaxDataConstants.TAX_IEPS_53_53, new String[] { "13945.79", "7391.26", "13945.79",
        "7391.26", "27891.58", "14782.54", "27891.58", "14782.54" });
    setDoctaxes(taxes);
    ...
    // totalNetCompletedAfterInsert, totalGrossDraftAfterUpdate, totalNetDraftAfterUpdate,
    // totalGrossCompletedAfterUpdate, totalNetCompletedAfterUpdate}
    String[] amounts = new String[] { "172062.99", "114335.59", "172062.99", "114335.59",
