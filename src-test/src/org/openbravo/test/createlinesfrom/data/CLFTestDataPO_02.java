 ...
 *
 */
public class CLFTestDataPO_02 extends CreateLinesFromTestData {

  public CLFTestDataPO_02() {
    this.orderLineData = Arrays
        .asList(new OrderLineData.Builder().productId(CLFTestDataConstants.PRODUCT_RMA)
            .orderedQuantity(BigDecimal.TEN)
            .build());

    this.invoiceLineData = Arrays
  ...
  public String getTestDescription() {
    return "Check Create Lines From Purchase Order with dimensions";
  }
