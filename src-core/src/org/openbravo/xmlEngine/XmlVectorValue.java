...
class XmlVectorValue extends Vector<Object> {
  ...
  private String replaceString(String original, HashMap<String, String> _textMap) {
    String result = "";
    result = _textMap.get(original);

    return result;
  }

  private String replaceString(String originalLine, String prefix, String suffix,
      HashMap<String, String> _textMap) {
    ...
    text = text.substring(0, end);
    String trlText = _textMap.get(text.trim());
