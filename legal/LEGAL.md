...
|------------------------------------------------------------------|--------------|-------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------|
| com.auth0:java-jwt                                               | 4.4.0        | [MIT](https://raw.githubusercontent.com/auth0/java-jwt/master/LICENSE)                    | [Package URL](https://mvnrepository.com/artifact/com.auth0/java-jwt/4.4.0)                                                     |
...
| com.sun.activation:javax.activation                              | 1.2.0        | [CDDL/GPLv2+CE](https://github.com/javaee/activation/blob/master/LICENSE.txt)             | [Package URL](https://mvnrepository.com/artifact/com.sun.activation/javax.activation/1.2.0)                                    |
...
| commons-logging:commons-logging                                  | 1.2          | [Apache 2.0](https://www.apache.org/licenses/LICENSE-2.0.txt)                             | [Package URL](https://mvnrepository.com/artifact/commons-logging/commons-logging/1.2)                                          |
...
| junit:junit                                                      | 4.12         | [EPL 1.0](https://www.eclipse.org/legal/epl-v10.html)                                     | [Package URL](https://mvnrepository.com/artifact/junit/junit/4.12)                                                             |
...
| org.antlr:antlr-complete                                         | 3.5.3        | [BSD](https://www.antlr3.org/license.html)                                                | [Package URL](https://mvnrepository.com/artifact/org.antlr/antlr-complete/3.5.3)                                               |
| org.apache.ant:ant-launcher                                      | 1.9.2        | [Apache 2.0](https://www.apache.org/licenses/LICENSE-2.0.txt)                             | [Package URL](https://mvnrepository.com/artifact/org.apache.ant/ant-launcher/1.9.2)                                            |
...
| org.apache.logging.log4j:log4j-slf4j-impl                        | 2.16.0       | [Apache 2.0](https://www.apache.org/licenses/LICENSE-2.0.txt)                             | [Package URL](https://mvnrepository.com/artifact/org.apache.logging.log4j/log4j-slf4j-impl/2.16.0)                             |
...
| org.codehaus.castor:castor-core                                  | 1.4.1        | [Apache 2.0](https://castor-data-binding.github.io/castor/about/licenses.html)            | [Package URL](https://mvnrepository.com/artifact/org.codehaus.castor/castor-core/1.4.1)                                        |
...
| org.codehaus.jettison:jettison                                   | 1.3          | [Apache 2.0](https://www.apache.org/licenses/LICENSE-2.0.txt)                             | [Package URL](https://mvnrepository.com/artifact/org.codehaus.jettison/jettison/1.3)                                           |
| org.codehaus.woodstox:wstx-asl                                   | 4.0.6        | [Apache 2.0](https://www.apache.org/licenses/LICENSE-2.0.txt)                             | [Package URL](https://mvnrepository.com/artifact/org.codehaus.woodstox/wstx-asl/4.0.6)                                         |
...
| org.hamcrest:hamcrest-all                                        | 1.3          | [BSD 3-Clause](https://opensource.org/licenses/BSD-3-Clause)                              | [Package URL](https://mvnrepository.com/artifact/org.hamcrest/hamcrest-all/1.3)                                                |
| org.hibernate.common:hibernate-commons-annotations              | 5.1.2.Final  | [LGPL 2.1](https://opensource.org/license/LGPL-2.1)                                       | [Package URL](https://mvnrepository.com/artifact/org.hibernate.common/hibernate-commons-annotations/5.1.2.Final)               |
...
| org.jboss.spec.javax.interceptor:jboss-interceptors-api_1.2_spec | 1.0.0.Final  | [CDDL 1.1](https://javaee.github.io/glassfish/LICENSE) [GPL+CE](https://openjdk.org/legal/gplv2+ce.html) | [Package URL](https://mvnrepository.com/artifact/org.jboss.spec.javax.interceptor/jboss-interceptors-api_1.2_spec/1.0.0.Final) |
...
| org.mozilla:rhino                                                | 1.8.0        | [MPL 2.0](https://www.mozilla.org/media/MPL/2.0/index.txt)                                | [Package URL](https://mvnrepository.com/artifact/org.mozilla/rhino/1.8.0)                                                      |
| org.mozilla:rhino-engine                                         | 1.8.0        | [MPL 2.0](https://www.mozilla.org/en-US/MPL/2.0/)                                         | [Package URL](https://mvnrepository.com/artifact/org.mozilla/rhino-engine/1.8.0)                                               |
| org.postgresql:postgresql                                        | 42.7.8       | [BSD-2-Clause](https://jdbc.postgresql.org/license/)                                      | [Package URL](https://mvnrepository.com/artifact/org.postgresql/postgresql/42.7.8)                                             |
...
| org.slf4j:slf4j-api                                              | 1.7.25       | [MIT](https://opensource.org/licenses/MIT)                                                | [Package URL](https://mvnrepository.com/artifact/org.slf4j/slf4j-api/1.7.25)                                                   |
...
| com.etendoerp:YUIAnt                                             | 1.0.0        | [BSD](https://github.com/acwwat/yuicompressor-ant?tab=BSD-2-Clause-1-ov-file#readme)      | [Package URL](https://github.com/etendosoftware/com.etendoerp.public.jars/packages/2443400)                                    |
| com.etendoerp:dbsm                                               | 1.4.0        | [Apache 2.0](https://www.apache.org/licenses/LICENSE-2.0.txt) [Openbravo Public License](./Openbravo_license.txt) | [Package URL](https://github.com/etendosoftware/dbsm/packages/2019938)                                                         |
| com.etendoerp:font.bitstreamverasans                             | 1.0.0        | [Bitstream Vera Fonts License](https://www.gnome.org/fonts/)                              | [Package URL](https://github.com/etendosoftware/com.etendoerp.public.jars)                                                     |
| com.etendoerp:analytics.exporter                                 | 3.2.0        | [Etendo License](./Etendo:license.txt) | [Package URL](https://github.com/etendosoftware/com.etendoerp.analytics.exporter/packages/2844154)                             |


## Elements of Compiere ERP & CRM 2.4.0 to 2.5.0e.
- In accordance with provision "3.2. Availability of Source Code" of the Compiere Public License 1.1 [Compiere_PL.txt](./Compiere_PL.txt), the source and modified source for the Compiere ERP & CRM files included in Openbravo ERP in this distribution are available under the Compiere Public license 1.1
...
## `/modules_core/org.openbravo.apachejdbcconnectionpool/lib/runtime`
  - tomcat-jdbc.jar
  - tomcat-juli.jar
    - All JARS under the Apache 2.0 license included as [Apache_license-2.0.txt](./Apache_license-2.0.txt)
