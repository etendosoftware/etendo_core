...
class UpdateFactAcctDescriptionData implements FieldProvider {
static Logger log4j = LogManager.getLogger();
  ...
  public static boolean isDescrUpdated(ConnectionProvider connectionProvider)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static int updateFactAcctDescription(ConnectionProvider connectionProvider)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        UPDATE fact_acct" +
