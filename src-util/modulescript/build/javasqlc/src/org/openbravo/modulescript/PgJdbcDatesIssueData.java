...
class PgJdbcDatesIssueData implements FieldProvider {
static Logger log4j = LogManager.getLogger();
  ...
  public static boolean existsAlert(ConnectionProvider connectionProvider, String name)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "       SELECT COUNT(*) AS EXISTING" +
      "       FROM AD_ALERTRULE" +
  ...
  public static String getAlertRuleId(ConnectionProvider connectionProvider, String name)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static int insertAlertRule(ConnectionProvider connectionProvider, String name)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static int insertAlert(ConnectionProvider connectionProvider, String description, String adAlertRuleId)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static int insertAlertRecipient(ConnectionProvider connectionProvider, String adAlertRuleId)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
