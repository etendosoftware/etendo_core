...
(function(OB, isc) {
  ...
  RecentUtilities.prototype = {
    getRecentNum: function() {
      ...
      if (
        !this.recentNum ||
        String(this.recentNum) !== String(parseInt(this.recentNum, 10))
      ) {
        this.recentNum = 3;
      }
      return this.recentNum;
    ...
    addRecent: function(propertyName, choiceObject) {
      ...
      var currentIndex = -1,
        i,
        length = currentRecentValue.length;
      for (i = 0; i < length; i++) {
        ...
        if (
          ...
          choiceObject.tabTitle &&
          choiceObject.tabTitle === currentRecentValue[i].tabTitle
        ) {
          currentIndex = i;
        } else if (
          currentRecentValue[i].recentId &&
          choiceObject.recentId &&
          choiceObject.recentId === currentRecentValue[i].recentId
        ) {
          currentIndex = i;
        } else if (
          currentRecentValue[i].id &&
