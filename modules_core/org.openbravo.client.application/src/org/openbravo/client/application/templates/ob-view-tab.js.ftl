...
<@compress single_line=true>
      {
        isProcessDefinition: ${button.processDefinition?string},
        <#if button.processDefinitionId??>
           processId: '${button.processDefinitionId}',
           windowTitle: '',
           command: '${button.actionHandler!}',
           actionHandler: '${button.actionHandler!}',
           uiPattern: '${button.uiPattern!}',
        </#if>
        action: function(){
          if (this.isProcessDefinition) {
            this.contextView = this.view;
            this.runProcess();
          } else {
            ${button.action}
          }
    ...
    showCloneButton:  ${tabComponent.showCloneButton?string},
    askToCloneChildren:  ${tabComponent.askToCloneChildren?string},
