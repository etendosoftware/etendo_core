...
/**
 * Do NOT use: use json dal webservice in com.smf.securewebservices
 * 
 *
 */
public class SecureJsonRestServlet extends BaseSecureWebServiceServlet {
  private static final Logger log = LogManager.getLogger();

  private static final long serialVersionUID = 1L;

  private static String servletPathPart = "jsondal";
