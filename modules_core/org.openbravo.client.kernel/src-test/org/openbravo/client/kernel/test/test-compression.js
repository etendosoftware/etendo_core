    ...
    actionToolbarButtons: [
      ...
      },
      {
        ...
        displayIf: function(item, value, form, currentValues) {
          ...
          return (
            context &&
            (currentValues.documentStatus !== 'VO' &&
              currentValues.documentStatus !== 'CL')
          );
        }
      }
    ],
    ...
    initWidget: function() {
      this.dataSource = OB.Datasource.create({
        ...
        fields: [
          ...
          {
            name:
              'client' + OB.Constants.FIELDSEPARATOR + OB.Constants.IDENTIFIER,
            type: 'text',
            hidden: true,
            canSave: false,
            title: 'client'
          ...
          {
            name:
              'charge' + OB.Constants.FIELDSEPARATOR + OB.Constants.IDENTIFIER,
            type: 'text',
            hidden: true,
            title: 'charge'
          },
          ...
          {
            name:
              'project' + OB.Constants.FIELDSEPARATOR + OB.Constants.IDENTIFIER,
            type: 'text',
            hidden: true,
            title: 'project'
          },
        ...
        fields: [
          ...
          },
          {
            ...
            optionDataSource: OB.Datasource.create({
              ...
              titleField: OB.Constants.IDENTIFIER,
              dataURL:
                '/openbravo/org.openbravo.service.datasource/F8DD408F2F3A414188668836F84C21AF',
              recordXPath: '/response/data',
              dataFormat: 'json',
              operationBindings: [
                {
              ...
              requestProperties: {
                params: {
                  ...
                  columnName: 'C_BPartner_ID',
                  _extraProperties:
                    'contactname,value,creditAvailable,locationid,contactid,creditUsed,name,customer,bpid,locationname,vendor,income'
                }
              },
              fields: []
            }),
          ...
          },
          {
            ...
            showIf: function(item, value, form, values) {
              ...
              return (
                !this.hiddenInForm &&
                context &&
                (context.ORDERTYPE === 'OB' || context.ORDERTYPE === 'SO')
              );
            },
            width: '50%',
            dummy: ''
          ...
          },
          {
            ...
            showIf: function(item, value, form, values) {
              ...
              return (
                !this.hiddenInForm &&
                context &&
                (context.ORDERTYPE === 'SO' ||
                  context.ORDERTYPE === 'WP' ||
                  context.ORDERTYPE === 'PR' ||
                  context.ORDERTYPE === 'WR')
              );
            },
            width: '*',
            dummy: ''
          ...
          },
          {
            ...
            showIf: function(item, value, form, values) {
              ...
              OB.Utilities.fixNull250(currentValues);
              return (
                !this.hiddenInForm && context && context.$Element_PJ === 'Y'
              );
            },
            displayField:
              'project' + OB.Constants.FIELDSEPARATOR + OB.Constants.IDENTIFIER,
          ...
          },
          {
            ...
            showIf: function(item, value, form, values) {
              ...
              return (
                !this.hiddenInForm &&
                context &&
                (currentValues.deliveryMethod === 'S' &&
                  (context.ORDERTYPE === 'SO' ||
                    context.ORDERTYPE === 'WP' ||
                    context.ORDERTYPE === 'PR' ||
                    context.ORDERTYPE === 'WR' ||
          ...
          },
          {
            ...
            showIf: function(item, value, form, values) {
              ...
              return (
                !this.hiddenInForm &&
                context &&
                (context.ORDERTYPE === 'SO' || context.ORDERTYPE === 'WP')
              );
            },
            width: '*',
            dummy: ''
          },
          {
            ...
            showIf: function(item, value, form, values) {
              ...
              OB.Utilities.fixNull250(currentValues);
              return (
                !this.hiddenInForm && context && context.ORDERTYPE === 'SO'
              );
            },
            width: '*',
            dummy: ''
          },
          {
            ...
            showIf: function(item, value, form, values) {
              ...
              return (
                ...
                context &&
                (context.ORDERTYPE === 'SO' &&
                  currentValues.freightCostRule === 'F')
              );
            },
            width: '50%',
            dummy: ''
          ...
          },
          {
            ...
            showIf: function(item, value, form, values) {
              ...
              OB.Utilities.fixNull250(currentValues);
              return (
                !this.hiddenInForm && context && context.$Element_MC === 'Y'
              );
            },
            width: '*',
            dummy: ''
          },
          {
            ...
            showIf: function(item, value, form, values) {
              ...
              OB.Utilities.fixNull250(currentValues);
              return (
                !this.hiddenInForm && context && context.$Element_AY === 'Y'
              );
            },
            width: '*',
            dummy: ''
          },
          {
            ...
            showIf: function(item, value, form, values) {
              ...
              OB.Utilities.fixNull250(currentValues);
              return (
                !this.hiddenInForm && context && context.$Element_OT === 'Y'
              );
            },
            width: '*',
            dummy: ''
          },
          {
            ...
            showIf: function(item, value, form, values) {
              ...
              OB.Utilities.fixNull250(currentValues);
              return (
                !this.hiddenInForm && context && context.$Element_U2 === 'Y'
              );
            },
            width: '*',
            dummy: ''
          },
          {
            ...
            showIf: function(item, value, form, values) {
              ...
              OB.Utilities.fixNull250(currentValues);
              return (
                !this.hiddenInForm && context && context.$Element_U1 === 'Y'
              );
            },
            width: '*',
            dummy: ''
      ...
      this.viewGrid = isc.OBViewGrid.create({
        ...
        fields: [
          {
            ...
            showHover: true,
            hoverHTML:
              "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'organization')])",
            filterOnKeypress: true,
            canFilter: true,
          ...
          },
          {
            ...
            showHover: true,
            hoverHTML:
              "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'documentNo')])",
          ...
          },
          {
            ...
            showHover: true,
            hoverHTML:
              "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'transactionDocument')])",
            filterOnKeypress: true,
            canFilter: true,
            filterEditorType: 'OBFKFilterTextItem',
            title: 'Transaction Document',
          ...
          },
          {
            ...
            showHover: true,
            hoverHTML:
              "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'businessPartner')])",
            filterOnKeypress: true,
            canFilter: true,
            filterEditorType: 'OBFKFilterTextItem',
            title: 'Business Partner',
          ...
          },
          {
            ...
            showHover: true,
            hoverHTML:
              "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'partnerAddress')])",
            filterOnKeypress: true,
            canFilter: true,
            filterEditorType: 'OBFKFilterTextItem',
            title: 'Partner Address',
          ...
          },
          {
            ...
            showHover: true,
            hoverHTML:
              "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'currency')])",
            filterOnKeypress: true,
            canFilter: true,
            filterEditorType: 'OBFKFilterTextItem',
            title: 'Currency',
          ...
          },
          {
            ...
            showHover: true,
            hoverHTML:
              "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'documentStatus')])",
          ...
          },
          {
            ...
            showHover: true,
            hoverHTML:
              "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'priceList')])",
            filterOnKeypress: true,
            canFilter: true,
            filterEditorType: 'OBFKFilterTextItem',
            title: 'Price List',
          ...
          },
          {
            ...
            showHover: true,
            hoverHTML:
              "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'paymentMethod')])",
            filterOnKeypress: true,
            canFilter: true,
            filterEditorType: 'OBFKFilterTextItem',
            title: 'Payment Method',
          ...
          },
          {
            ...
            showHover: true,
            hoverHTML:
              "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'paymentTerms')])",
            filterOnKeypress: true,
            canFilter: true,
            filterEditorType: 'OBFKFilterTextItem',
            title: 'Payment Terms',
          ...
          },
          {
            ...
            showHover: true,
            hoverHTML:
              "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'warehouse')])",
            filterOnKeypress: true,
            canFilter: true,
            filterEditorType: 'OBFKFilterTextItem',
            title: 'Warehouse',
          ...
          },
          {
            ...
            showHover: true,
            hoverHTML:
              "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'invoiceTerms')])",
            width: isc.OBGrid.getDefaultColumnWidth(44),
            name: 'invoiceTerms',
            canExport: true,
            canHide: true,
          ...
          },
          {
            ...
            showHover: true,
            hoverHTML:
              "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'userContact')])",
            filterOnKeypress: true,
            canFilter: true,
            filterEditorType: 'OBFKFilterTextItem',
            title: 'User/Contact',
          ...
          },
          {
            ...
            showHover: true,
            hoverHTML:
              "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'project')])",
            filterOnKeypress: true,
            canFilter: true,
            filterEditorType: 'OBFKFilterTextItem',
            title: 'Project',
          ...
          },
          {
            ...
            showHover: true,
            hoverHTML:
              "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'documentType')])",
            filterOnKeypress: true,
            canFilter: true,
            filterEditorType: 'OBFKFilterTextItem',
            title: 'Document Type',
          ...
          },
          {
            ...
            showHover: true,
            hoverHTML:
              "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'orderReference')])",
          ...
          },
          {
            ...
            showHover: true,
            hoverHTML:
              "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'salesRepresentative')])",
            filterOnKeypress: true,
            canFilter: true,
            filterEditorType: 'OBFKFilterTextItem',
            title: 'Sales Representative',
          ...
          },
          {
            ...
            showHover: true,
            hoverHTML:
              "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'description')])",
          ...
          },
          {
            ...
            showHover: true,
            hoverHTML:
              "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'invoiceAddress')])",
            filterOnKeypress: true,
            canFilter: true,
            filterEditorType: 'OBFKFilterTextItem',
            title: 'Invoice Address',
          ...
          },
          {
            ...
            showHover: true,
            hoverHTML:
              "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'deliveryLocation')])",
            filterOnKeypress: true,
            canFilter: true,
            filterEditorType: 'OBFKFilterTextItem',
            title: 'Delivery Location',
          ...
          },
          {
            ...
            showHover: true,
            hoverHTML:
              "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'deliveryMethod')])",
            width: isc.OBGrid.getDefaultColumnWidth(21),
            name: 'deliveryMethod',
            canExport: true,
            canHide: true,
          ...
          },
          {
            ...
            showHover: true,
            hoverHTML:
              "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'shippingCompany')])",
            filterOnKeypress: true,
            canFilter: true,
            filterEditorType: 'OBFKFilterTextItem',
            title: 'Shipping Company',
          ...
          },
          {
            ...
            showHover: true,
            hoverHTML:
              "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'deliveryTerms')])",
            width: isc.OBGrid.getDefaultColumnWidth(21),
            name: 'deliveryTerms',
            canExport: true,
            canHide: true,
          ...
          },
          {
            ...
            showHover: true,
            hoverHTML:
              "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'freightCostRule')])",
            width: isc.OBGrid.getDefaultColumnWidth(21),
            name: 'freightCostRule',
            canExport: true,
            canHide: true,
          ...
          },
          {
            ...
            showHover: true,
            hoverHTML:
              "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'priority')])",
            width: isc.OBGrid.getDefaultColumnWidth(21),
            name: 'priority',
            canExport: true,
            canHide: true,
          ...
          },
          {
            ...
            showHover: true,
            hoverHTML:
              "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'salesCampaign')])",
            filterOnKeypress: true,
            canFilter: true,
            filterEditorType: 'OBFKFilterTextItem',
            title: 'Sales Campaign',
          ...
          },
          {
            ...
            showHover: true,
            hoverHTML:
              "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'charge')])",
            filterOnKeypress: true,
            canFilter: true,
            filterEditorType: 'OBFKFilterTextItem',
            title: 'Charge',
          ...
          },
          {
            ...
            showHover: true,
            hoverHTML:
              "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'activity')])",
            filterOnKeypress: true,
            canFilter: true,
            filterEditorType: 'OBFKFilterTextItem',
            title: 'Activity',
          ...
          },
          {
            ...
            showHover: true,
            hoverHTML:
              "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'trxOrganization')])",
            filterOnKeypress: true,
            canFilter: true,
            filterEditorType: 'OBFKFilterTextItem',
            title: 'Trx Organization',
          ...
          },
          {
            ...
            showHover: true,
            hoverHTML:
              "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'ndDimension')])",
            width: isc.OBGrid.getDefaultColumnWidth(44),
            name: 'ndDimension',
            canExport: true,
            canHide: true,
          ...
          },
          {
            ...
            showHover: true,
            hoverHTML:
              "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'stDimension')])",
            width: isc.OBGrid.getDefaultColumnWidth(44),
            name: 'stDimension',
            canExport: true,
            canHide: true,
          ...
          },
          {
            ...
            showHover: true,
            hoverHTML:
              "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'client')])",
            filterOnKeypress: true,
            canFilter: true,
            filterEditorType: 'OBFKFilterTextItem',
            title: 'Client',
          ...
          },
          {
            ...
            showHover: true,
            hoverHTML:
              "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'formOfPayment')])",
            width: isc.OBGrid.getDefaultColumnWidth(21),
            name: 'formOfPayment',
            canExport: true,
            canHide: true,
          ...
          },
          {
            ...
            showHover: true,
            hoverHTML:
              "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'dropShipContact')])",
            filterOnKeypress: true,
            canFilter: true,
            filterEditorType: 'OBFKFilterTextItem',
          ...
          },
          {
            ...
            showHover: true,
            hoverHTML:
              "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'dropShipPartner')])",
            filterOnKeypress: true,
            canFilter: true,
            filterEditorType: 'OBFKFilterTextItem',
          ...
          },
          {
            ...
            showHover: true,
            hoverHTML:
              "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'dropShipLocation')])",
            filterOnKeypress: true,
            canFilter: true,
            filterEditorType: 'OBFKFilterTextItem',
          ...
          },
          {
            ...
            showHover: true,
            hoverHTML:
              "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'deliveryNotes')])",
          ...
          },
          {
            ...
            showHover: true,
            hoverHTML:
              "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'incoterms')])",
            filterOnKeypress: true,
            canFilter: true,
            filterEditorType: 'OBFKFilterTextItem',
            title: 'Incoterms',
          ...
          },
          {
            ...
            showHover: true,
            hoverHTML:
              "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'iNCOTERMSDescription')])",
        ...
        filterClause:
          " ( e.updated > @transactionalRange@  or e.processed = 'N' ) ",
        filterName:
          'This grid is filtered using transactional filter <i>(only draft & modified documents in the last 1 day(s))</i>.',
    ...
    createViewStructure: function() {
                  ...
                  showIf: function(item, value, form, values) {
                    ...
                    return (
                      ...
                      ((context.ATTRIBUTESET !== '' &&
                        context.ATTRSETVALUETYPE !== 'F') ||
                        (currentValues.attributeSetValue !== '' &&
                          currentValues.attributeSetValue !== '0'))
                    );
                  },
                  displayField:
                    'attributeSetValue' +
                ...
                },
                {
                  ...
                  showIf: function(item, value, form, values) {
                    ...
                    return (
                      !this.hiddenInForm &&
                      context &&
                      currentValues.directShipment === false
                    );
                  },
                  width: '*',
                  dummy: ''
            ...
            this.viewGrid = isc.OBViewGrid.create({
              ...
              fields: [
                ...
                },
                {
                  ...
                  showHover: true,
                  hoverHTML:
                    "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'product')])",
                  filterOnKeypress: true,
                  canFilter: true,
                  filterEditorType: 'OBFKFilterTextItem',
                  title: 'Product',
                ...
                },
                {
                  ...
                  showHover: true,
                  hoverHTML:
                    "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'attributeSetValue')])",
                  filterOnKeypress: true,
                  canFilter: true,
                  filterEditorType: 'OBFKFilterTextItem',
                  title: 'Attribute Set Value',
                ...
                },
                {
                  ...
                  showHover: true,
                  hoverHTML:
                    "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'uOM')])",
                  filterOnKeypress: true,
                  canFilter: true,
                  filterEditorType: 'OBFKFilterTextItem',
                  title: 'UOM',
                ...
                },
                {
                  ...
                  showHover: true,
                  hoverHTML:
                    "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'tax')])",
                  filterOnKeypress: true,
                  canFilter: true,
                  filterEditorType: 'OBFKFilterTextItem',
                  title: 'Tax',
                ...
                },
                {
                  ...
                  showHover: true,
                  hoverHTML:
                    "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'orderUOM')])",
                  filterOnKeypress: true,
                  canFilter: true,
                  filterEditorType: 'OBFKFilterTextItem',
                  title: 'Order UOM',
                ...
                },
                {
                  ...
                  showHover: true,
                  hoverHTML:
                    "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'resourceAssignment')])",
                  width: isc.OBGrid.getDefaultColumnWidth(14),
                  name: 'resourceAssignment',
                  canExport: true,
                  canHide: true,
                ...
                },
                {
                  ...
                  showHover: true,
                  hoverHTML:
                    "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'orderDiscount')])",
                  filterOnKeypress: true,
                  canFilter: true,
                  filterEditorType: 'OBFKFilterTextItem',
                ...
                },
                {
                  ...
                  showHover: true,
                  hoverHTML:
                    "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'priceAdjustment')])",
                  filterOnKeypress: true,
                  canFilter: true,
                  filterEditorType: 'OBFKFilterTextItem',
              ...
              isc.OBStandardView.create({
                ...
                initWidget: function() {
                  this.dataSource = OB.Datasource.create({
                    ...
                    titleField: OB.Constants.IDENTIFIER,
                    dataURL:
                      '/openbravo/org.openbravo.service.datasource/OrderLineOffer',
                    recordXPath: '/response/data',
                    dataFormat: 'json',
                    operationBindings: [
                      {
              ...
              isc.OBStandardView.create({
                ...
                initWidget: function() {
                  this.dataSource = OB.Datasource.create({
                    ...
                    titleField: OB.Constants.IDENTIFIER,
                    dataURL:
                      '/openbravo/org.openbravo.service.datasource/OrderLineTax',
                    recordXPath: '/response/data',
                    dataFormat: 'json',
                    operationBindings: [
                      {
        ...
        isc.OBStandardView.create({
          ...
          initWidget: function() {
            this.dataSource = OB.Datasource.create({
              ...
              titleField: OB.Constants.IDENTIFIER,
              dataURL:
                '/openbravo/org.openbravo.service.datasource/OrderDiscount',
              recordXPath: '/response/data',
              dataFormat: 'json',
              operationBindings: [
                {
            ...
            this.viewGrid = isc.OBViewGrid.create({
              ...
              fields: [
                ...
                },
                {
                  ...
                  showHover: true,
                  hoverHTML:
                    "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'discount')])",
                  filterOnKeypress: true,
                  canFilter: true,
                  filterEditorType: 'OBFKFilterTextItem',
                  title: 'Discount',
      ...
      this.addChildView(
        isc.OBStandardView.create({
          ...
          defaultEditMode: false,
          mapping250:
            '/SalesOrder/PaymentInPlanEB0E0C5A58344F7FA345097E7365CD22',
          isAcctTab: false,
          isTrlTab: false,
          standardProperties: {
          ...
          initWidget: function() {
            this.dataSource = OB.Datasource.create({
              ...
              titleField: OB.Constants.IDENTIFIER,
              dataURL:
                '/openbravo/org.openbravo.service.datasource/FIN_Payment_Sched_Ord_V',
              recordXPath: '/response/data',
              dataFormat: 'json',
              operationBindings: [
                {
            ...
            this.viewGrid = isc.OBViewGrid.create({
              ...
              fields: [
                ...
                },
                {
                  ...
                  showHover: true,
                  hoverHTML:
                    "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'invoice')])",
                  filterOnKeypress: true,
                  canFilter: true,
                  filterEditorType: 'OBFKFilterTextItem',
                  title: 'Invoice',
          ...
          createViewStructure: function() {
            this.addChildView(
              isc.OBStandardView.create({
                ...
                defaultEditMode: false,
                mapping250:
                  '/SalesOrder/PaymentInDetailsB82C02920AA84E8DB57D553185BD2F06',
                isAcctTab: false,
                isTrlTab: false,
                standardProperties: {
                ...
                initWidget: function() {
                  this.dataSource = OB.Datasource.create({
                    ...
                    titleField: OB.Constants.IDENTIFIER,
                    dataURL:
                      '/openbravo/org.openbravo.service.datasource/FIN_Payment_Detail_V',
                    recordXPath: '/response/data',
                    dataFormat: 'json',
                    operationBindings: [
                      {
                  ...
                  this.viewForm = isc.OBViewForm.create({
                    fields: [
                      ...
                      },
                      {
                        ...
                        required: false,
                        showIf: function(item, value, form, values) {
                          var context = form.view.getContextInfo(
                              false,
                              true,
                              true
                            ),
                  ...
                  this.viewGrid = isc.OBViewGrid.create({
                    ...
                    fields: [
                      ...
                      },
                      {
                        ...
                        showHover: true,
                        hoverHTML:
                          "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'paymentno')])",
                        width: isc.OBGrid.getDefaultColumnWidth(30),
                        name: 'paymentno',
                        canExport: true,
                        canHide: true,
                      ...
                      },
                      {
                        ...
                        showHover: true,
                        hoverHTML:
                          "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'finFinancialAccount')])",
                        filterOnKeypress: true,
                        canFilter: true,
                        filterEditorType: 'OBFKFilterTextItem',
                        title: 'Financial Account',
                      ...
                      },
                      {
                        ...
                        showHover: true,
                        hoverHTML:
                          "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'payment')])",
                        filterOnKeypress: true,
                        canFilter: true,
                        filterEditorType: 'OBFKFilterTextItem',
                        title: 'Payment In',
                      ...
                      },
                      {
                        ...
                        editorProperties: {
                          ...
                          changed: function(form, item, value) {
                            ...
                            this.Super('changed', arguments);
                            form.onFieldChanged(form, item, value);
                            form.view.toolBar.refreshCustomButtonsView(
                              form.view
                            );
                          }
                        },
                      ...
                      },
                      {
                        ...
                        showHover: true,
                        hoverHTML:
                          "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'finaccCurrency')])",
                        filterOnKeypress: true,
                        canFilter: true,
                        filterEditorType: 'OBFKFilterTextItem',
                      ...
                      },
                      {
                        ...
                        showHover: true,
                        hoverHTML:
                          "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'orderno')])",
                        width: isc.OBGrid.getDefaultColumnWidth(30),
                        name: 'orderno',
                        canExport: true,
                        canHide: true,
                      ...
                      },
                      {
                        ...
                        showHover: true,
                        hoverHTML:
                          "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'invoiceno')])",
                        width: isc.OBGrid.getDefaultColumnWidth(30),
                        name: 'invoiceno',
                        canExport: true,
                        canHide: true,
        ...
        isc.OBStandardView.create({
          ...
          initWidget: function() {
            this.dataSource = OB.Datasource.create({
              ...
              titleField: OB.Constants.IDENTIFIER,
              dataURL:
                '/openbravo/org.openbravo.service.datasource/FinancialMgmtDebtPayment',
              recordXPath: '/response/data',
              dataFormat: 'json',
              operationBindings: [
                {
              ...
              fields: [
                {
                  ...
                  showHover: true,
                  hoverHTML:
                    "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'settlementCancelled')])",
                  filterOnKeypress: true,
                  canFilter: true,
                  filterEditorType: 'OBFKFilterTextItem',
                  title: 'Settlement Cancelled',
                ...
                },
                {
                  ...
                  showHover: true,
                  hoverHTML:
                    "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'cashbook')])",
                  filterOnKeypress: true,
                  canFilter: true,
                  filterEditorType: 'OBFKFilterTextItem',
                  title: 'Cashbook',
                ...
                },
                {
                  ...
                  showHover: true,
                  hoverHTML:
                    "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'cashJournalLine')])",
                  filterOnKeypress: true,
                  canFilter: true,
                  filterEditorType: 'OBFKFilterTextItem',
                  title: 'Cash Journal Line',
                ...
                },
                {
                  ...
                  showHover: true,
                  hoverHTML:
                    "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'bankAccount')])",
                  filterOnKeypress: true,
                  canFilter: true,
                  filterEditorType: 'OBFKFilterTextItem',
                  title: 'Bank Account',
                ...
                },
                {
                  ...
                  showHover: true,
                  hoverHTML:
                    "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'bankStatementLine')])",
                  filterOnKeypress: true,
                  canFilter: true,
                  filterEditorType: 'OBFKFilterTextItem',
                  title: 'Bank Statement Line',
                ...
                },
                {
                  ...
                  showHover: true,
                  hoverHTML:
                    "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'initialStatus')])",
                  width: isc.OBGrid.getDefaultColumnWidth(21),
                  name: 'initialStatus',
                  canExport: true,
                  canHide: true,
                ...
                },
                {
                  ...
                  showHover: true,
                  hoverHTML:
                    "return grid.getDisplayValue(colNum, record[(this.displayField ? this.displayField : 'settlementGenerate')])",
                  filterOnKeypress: true,
                  canFilter: true,
                  filterEditorType: 'OBFKFilterTextItem',
