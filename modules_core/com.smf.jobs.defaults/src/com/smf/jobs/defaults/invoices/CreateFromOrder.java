    ...
    protected ActionResult action(JSONObject parameters, MutableBoolean isStopped) {
        ...
        try {
            ...
            if (!input.isEmpty()) {
                ...
                final var processInstance = CallProcess.getInstance().callProcess(invoiceCreateProcess, null, processParameters, null);
                ...
                for (GenerateInvoicesHook hook : hooks) {
                    var hookResult = hook.executeHook(new DalConnectionProvider().getConnection(), input, processResult.toOBError());
