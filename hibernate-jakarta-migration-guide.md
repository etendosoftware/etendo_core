...
`javax.servlet.*` moves to `jakarta.servlet.*` in Jakarta EE 9. This applies to both import statements **and** inline fully-qualified names in method signatures and code bodies (e.g., `extends javax.servlet.http.HttpServletResponseWrapper`).
...
_More migration changes will be added to this guide as the migration progresses._
